...
class GenderWisesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('gender_wises')->delete();
        
        \DB::table('gender_wises')->insert(array (
            0 => 
            array (
                'id' => 1,
                'title' => 'Gender wise student list',
                'title_bn' => 'লিঙ্গভিত্তিক শিক্ষার্থীর লিস্ট',
...
<p class="MsoNormal"><o:p>&nbsp;</o:p></p>',
                'image' => '0',
                'created_at' => NULL,
                'updated_at' => '2023-09-20 05:34:33',
            ),
        ));
