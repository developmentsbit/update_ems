...
<input type='button'  onClick="return showChekTo()" class='btn btn-success btn-sm' value='Search' />
            ...
            <tr>
              ...
              <td width="11%" align="center">&nbsp;<strong><span class="text-justify text-danger">Practical </span></td>
              <td width="11%" align="center">&nbsp;<strong><span class="text-justify text-danger">Cont. Ass.</span></td>
	...
	`student_acadamic_information`.`session2` FROM `running_student_info` INNER JOIN `examinee_reg` ON `examinee_reg`.`student_id`=`running_student_info`.`student_id` JOIN `subject_registration_table` ON `subject_registration_table`.`std_id`=`running_student_info`.`student_id`
