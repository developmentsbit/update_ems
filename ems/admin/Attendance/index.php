...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">
	...
	<body>
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
              <ul class="nav navbar-nav">
				...
				<!--   <li><a href="../StruffAttendance.php" target="ifrmae">Staff Attendance </a></li -->
				  <li><a href="../dailyAttendanceSheet.php" target="ifrmae">Daily Student Attendance Sheet </a></li> 
				   <li><a href="../DateWiseStudentAttendanceReport.php" target="ifrmae">Student  Report </a></li> 
				   <li><a href="../singleStdAttendanceReport.php" target="ifrmae">Single Student Attendance  </a></li> 
				   <li><a href="../singleTeacherReport.php" target="_blank">Single Teacher Attendance  </a></li> 
				   <li><a href="../dailyAttendanceTeacher.php" target="_blank">Daily Teacher Attendance  </a></li> 
				    <li><a href="../Teacher'sAttendanceReport.php" target="_blank">Date wise Teacher Attendance </a></li> 
		...
		<div class="col-md-12">
					<iframe src="../dailyAttendanceSheet.php" name="ifrmae" style="height:800px; width:100%"></iframe>
