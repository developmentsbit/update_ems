<?php
  ...
  $select="SELECT * FROM `bnccinformation`";
   ...
   if($checked_query)
    ...
    if(isset($_POST['add']))
    {
      ...
      $about_school=$db->escape($_POST['Contact_Textarea']);
    	...
    	{
    	$insert="INSERT INTO `bnccinformation` VALUES('1','$title','$about_school')";
  ...
  if(isset($_POST['Update']))
    {
      ...
      {
      	$insert="REPLACE INTO `bnccinformation` VALUES('1','$title','$about_school')";
...
if(isset($_POST['Delete'])){
	$Delete="DELETE FROM `bnccinformation` WHERE `id`='1'";
	$db->delete_query($Delete);
  print "<script>location='BNCCinformation.php'</script>";
...
<body>
  ...
  <div class="panel-heading" style="font-size: 16px; color: #16a085; text-transform: uppercase;"><b>BNCC Information</b></div>
