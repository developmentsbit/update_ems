  <?php
	...
	if(isset($_POST["ResultGenerate"])){
			...
			print "<script>location='showBlankMarksheet.php?clID=$classID[0]&session=$Session&gpna=$groupname[0]&fromroll=$fromroll&to=$toroll'</script>";
	}
...
function Check_exam_type()
{
  ...
  <body>
  	<form name="teacherinfo" action="" method="post"  enctype="multipart/form-data" class="form-horizontal marksEditEntry" target="_blank" >
...
<input type="text" name="to" id="to"  style="width:120px; background:#F7071D; border:none; font-weight:bold; color:#fff; height:25px;  text-align:center;"/>
				...
				<input type="submit" name="ResultGenerate" value="Show Marksheet" class="btn btn-danger btn-md" style="width: 180px" ></input>
				</td></tr>
                </table>
