...
<html lang="en">
  <head>
    ...
    <title>CASH TRANSACTION STATEMENT </title>
...
<form method="get"  action="ViewCashTranactionStatement.php">

  	  <div class="col-sm-12 col-xs-12" style="margin-top: 30px;">

  <div class="panel panel-default" style="border-radius: 0px;">
  <div class="panel-heading" style="font-size: 16px; color: #16a085; text-transform: uppercase;"><b>Cash Transaction Statement</b></div>
