			...
			function showData(){
				...
				var type=$("#type").val();
						$.ajax({
									...
									type:"POST",
									data:$(".addATeent").serialize() + "&showdata=" + showdata + "&type=" + type,
	...
	@media print{
	 ...
	 <div class="col-lg-12 col-md-12">
	  <table width="1075" id="notprint" class="table table-bordered table-responsive" style="margin-top:10px; margin-bottom:0px">
						  <tr>
							<td colspan="8" align="center">&nbsp;<span class="text-success" style="font-size:18px;"><strong>Date Wise Students Attendance Report</strong></span></td>
						  </tr>
						  
						   <tr>
						  		<td>Select Class</td>
								<td>
									<select class="form-control" id="selectClass" name="selectClass" onchange="return check_period()"  style="width:250px; height:30px; padding-left:5px;">
								...
								<td>Select Period</td>
								<td><select class="form-control" id="Period" name="Period" style="width:250px; padding-left:5px; height:30px;" >
											
									</select></td>

									<td>Select Date</td>
								<td><input type="text" class="form-control" name="example1" id="example1"  autocomplete="off" autocomplete="off" style="width:250px; padding-left:5px; height:30px;"/></td>
								
								<td>Type</td>
								<td>
								    
								    <select class="form-control" id="type" name="type"  style="width:250px; height:30px; padding-left:5px;">
