...
error_reporting(1);
	...
	if(isset($_POST["ResultGenerate"])){
			...
			if(isset($classID) and $classID != "Select One" and isset($examtype) and $examtype != "Select Exam Name" and isset($Session) and $Session != "Select Session"){
					print "<script>location='classWiseFailedStudentReport.php?clID=$classID[0]&exId=$examtype[0]&session=$Session'</script>";
			}else{
  ...
  <body>
  	<form name="teacherinfo" action="" method="post"  enctype="multipart/form-data" class="form-horizontal marksEditEntry" >
            <div class="col-md-8 col-md-offset-2" id="AddMarksStep1"><br/> <br/>
                <span class="glyphicon glyphicon-arrow-right text-justify text-uppercase text-warning" style="font-weight: bold; padding-top: 15px; font-size: 18px;"><strong style="padding-left:5px">Class Wise Failed Student Merit List</strong></span><br/>
