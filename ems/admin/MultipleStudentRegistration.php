...
function check_optional_subject()
{
        ...
        var totallimi=to-from;
			...
			if(session != "" && to != "" ){
				...
				data : {autoID:autoID,session:session,to:to,from:from,classs:classs,gpfffff:gpfffff,examtype:examtype,Gender:Gender},
				type : "POST",
    ...
    <table align="center"  class="table table-bordered  table-responsive table-hover" style="margin-top:30px;"><tr>
			...
			<tr>
				...
				<td align="">
					...
					<div class="col-md-8"><select class="form-control" id="class" name="class"  onChange="return check_group(), Check_exam_type()">
				...
				<td align="">
					...
					<div class="col-md-4">
					    <label for="session">Select Group</label>
					        <select class="form-control" id="gpfffff" name="gpfffff"> </select>
                    </div>
                        

                          <div class="col-md-4">
                              	<label for="session">Select Exam</label>
                              <select class="form-control" name="examtype" id="examtype" style="width:280px; border-radius:0px;" >
                        </select>
                        </div>
                         <div class="col-md-4">
                              	<label for="session">Select Gender</label>
                              <select class="form-control" name="Gender" id="Gender" style="width:280px; border-radius:0px;" >
                                  <option>Male</option>
