   ...
   if($checked_query)
    ...
    if(isset($_POST['add']))
    {
      ...
      $about_school=$db->escape($_POST['Contact_Textarea']);
    	if(!empty($about_school))
    	{
    	$insert="INSERT INTO `onlineapplicantdashboard` VALUES('1','Online Applicant','$about_school')";
  ...
  if(isset($_POST['Update']))
    {
      ...
      if(!empty($about_school))
      {
      	$insert="REPLACE INTO `onlineapplicantdashboard` VALUES('1','Online Applicant','$about_school')";
...
if(isset($_POST['Delete'])){
	$Delete="DELETE FROM `onlineapplicantdashboard` WHERE `id`='1'";
...
<body>
  ...
  <div class="panel-heading" style="font-size: 16px; color: #16a085; text-transform: uppercase;"><b>Online Applicant Dashboard</b></div>
