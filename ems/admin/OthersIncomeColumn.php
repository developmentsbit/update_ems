<?php
	...
	$fetch[5]="";
	$prefix=date("y"."m"."d");
	$fetch[0]=$db->withoutPrefix('income_coloumn','id',"00".$prefix,'10');
	global $chek;
...
if(isset($_POST['add']))
	{
		...
		{
			$query="INSERT INTO `income_coloumn` VALUES ('".$fetch[0]."','$title','$year','$sl')";
...
if(isset($_POST['Update']))
	{
		...
		if(!empty($id) && !empty($year) && !empty($title) )
		{
			$query="REPLACE  INTO `income_coloumn` VALUES ('".$_POST["id"]."','$title','$year','$sl')";
			$resultisnsert=$db->update_query($query);
			//print_r($query);
				$src_text=$db->escape($_POST['id']);
		$query="SELECT * FROM `income_coloumn` WHERE `id`='".$_POST["id"]."'";
...
//view data...............................	
	if(isset($_POST['View']))
	{
        ...
        $table.="<tr class='warning' >"."<td align='left' colspan='7'>"."<a href='OthersIncomeColumn.php' class='btn btn-primary'>"."<span class='link text-center'>Back<span>"."</a>"."<span class='text-success' style='font-size:18px; padding-left:380px; font-weight:blod;'>Show All </span>"."</td>"."</tr>";
...
//link edit data...................................	
	...
	if(isset($_GET['edit']))
	{
		...
		$queryg="SELECT * FROM `income_coloumn` WHERE `id`='".$_GET["edit"]."'";
...
?>
  	...
  	<table align="center" class="table table-responsive box" style="border:1px #CCCCCC solid; margin-top:30px; color: #000;">
  			<tr>
  				<td bgcolor="#f4f4f4"   class="warning" colspan="4" bgcolor="#dddddd"  align="center"><span style="font-size:22px; color:#333; display:block;">Add Others Income Column  </span> </td>
  			</tr>
