<?php
  ...
  { 
    ...
    $sql="SELECT other_income.`id`,`other_income`.`date`,`income_expense_title`.`title`,`other_income`.`description`,`other_income`.`amount`,`other_income`.`EntryDate`,`address`,`receivedFrom` FROM other_income INNER JOIN `income_expense_title`
ON `income_expense_title`.`id`= other_income.`title` WHERE `income_expense_title`.`type`='Income' and  other_income.`id`='".$_GET['id']."'";
...
<html lang="en">
 ...
 <p style="margin-top:-1px;font-size:16px;font-family:Arial, Helvetica, sans-serif"> <?php print $fetcproject['location'];?>   </p>
   ...
   <tr>
                    <td width="20" align="center" colspan="5"><h4>Other's Income</h4></td>
                   ...
                   <tr>
                    <td  align="center" colspan="5">
                          ...
                          <table class="table table-bordered">
                              ...
                              <tr>
                                <td> Received From :</td>
                                <td> <?php print $fetchData['receivedFrom']?></td>
                                <td> Address</td>
...
(In word): Tk. <?php 
           ...
           ?> Only &nbsp;
                    ...
                    <td width="100" align="center"><?php print $tk; ?></td>
                  </tr>
