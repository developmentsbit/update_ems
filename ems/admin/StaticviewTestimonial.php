...
.style17 {font-size: 16px}
	...
	<div style="float:left; clear:right; width:350px;">
	  <table style="width:100%; margin-top:10px;"  height="145" border="0" cellpadding="0" cellspacing="0" >
        ...
        <tr>
          <td width="71" height="75" align="center">&nbsp;</td>
          <td width="307" align="center">&nbsp;<span style="font-size:20px; font-weight:bold; letter-spacing:1; color:#940320; font-family:sans-serif">AL HELAL ACADEMY </span><br/>
		    <span style=" font-size:16px">P.O. & Upazilla :Sonagazi, District :Feni.</span><br/>		  </td>
 ...
 <table style="width:100%"  height="44" border="0" cellpadding="0" cellspacing="0">
	  ...
	  <div style="float:left; margin-left:20px; width:1100px; ">
	 

 <img src="all_image/testimonialSDMS2015.jpg"  style="margin-top: 3px; margin-right: 45px; height: 890px; width: 1100px;" />
	     ...
	     <table  width="810" height="870" border="0"  style="margin-top:-800px; background:none; position:relative; "    cellpadding="0" cellspacing="0" align="center">
        <tr>
          <td colspan="3">
 ...
 <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="margin-top: 10px;">
        ...
        <tr>
          <td align="center" height="22"><span style="color:#990000; font-family:Arial, Helvetica, sans-serif; font-size:40px; font-weight:bold; letter-spacing:1px;">AL HELAL ACADEMY </span></td>
        </tr>
        <tr>
          <td height="27"  align="center" valign="top"><span style="color:#000; font-family:Arial, Helvetica, sans-serif; font-size:16px; font-weight:bold; letter-spacing:1px;"><br>P.O. & Upazilla : Sonagazi, District : Feni.<br>
          	Estd. : 1984, EIIN: 106710, Centre Code: 612 </span></td>
          </tr>
        
        <tr>
          <td rowspan="2" align="center"><br> <p><span style="color:#000; font-family:Arial, Helvetica, sans-serif; font-size:26px; font-weight:bold; letter-spacing:1px; background:#482257; color:#FFFFFF; padding:10px; border-radius:15px;">Testimonial </span></p></td>
          </tr>
        ...
        <tr>
          <td height="310" width="905" colspan="3" style="padding-left:0px; line-height:30px;  " >
...
?></b>
			...
			?></b> group and secured GPA <b>  :&nbsp<?php
					if(isset($fetchForall)){
						echo $fetchForall["GPA"];
					}
					else {
	...
	<br/> 
		...
		?> bears a good moral character and did not take part in any activities subversive of the institute. <br>
          ...
          <td colspan="4">
          		...
          		<table width="100%" style="margin-top:30px;">
			          ...
			          <td width="30%" align="right">...........................................................<br>
			          	...
			          	<span style="font-weight: bold; font-size: 20px; font-family: Arial block;">Headmaster </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<p>Al Helal Academy, Sonagazi.</p>
