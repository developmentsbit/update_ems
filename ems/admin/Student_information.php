<?php
 ...
 if(isset($_POST['savedata']))
    ...
    if(isset($_POST['Update']))
    {
        ...
        @move_uploaded_file($_FILES["file"]["tmp_name"],$strfimg);
        @chmod($strfimg,0644);
         $msg="<span style='color:GREEN'>Update Successfully!!</span>";
}
...
`meritial_status`,`blood_group`,`nationality`,`contact_no`,`email`,`student_address_info`.`present_house_name`,`present_village`,`present_PO`,`present_post_code`,`present_upazila`, 
 ...
 WHERE `student_personal_info`.`id`='".$_GET["edit"]."'";
    ...
    if(isset($_GET["dlt"]))
    {
            ...
            $delete_query1="DELETE FROM `student_acadamic_information` WHERE `id`='".$_GET["dlt"]."'";   
            $delete_query2="DELETE FROM `student_address_info` WHERE `id`='".$_GET["dlt"]."'";        
            ...
            $sql3="DELETE FROM `running_student_info` WHERE `student_id`='".$_GET["dlt"]."'";
            $db->delete_query($sql3);
            $sql4="DELETE FROM `subject_registration_table` WHERE `std_id`='".$_GET["dlt"]."'";
    ...
    if(isset($_GET["formid"]))
    {
        $select_student="SELECT `reg_student_personal_info`.`id`,`addmission_date`,`student_name`,`father_name`,`mother_name`,`gender`,`date_of_brith`,`religious`, `meritial_status`,`blood_group`,`nationality`,`contact_no`,`email`, `reg_student_previous_result`.`psc_board`,`psc_institute`,`psc_registration`, `psc_Year`,`psc_roll`,`psc_group`,`psc_GPA`,`psc_passing_year`,`reg_student_address_info`.`present_house_name`,`present_village`,`present_PO`,`present_post_code`,`present_upazila`, `present_distric`,`permanent_house_name`,`permanent_village`, `permanent_PO`,`permanent_post_code`,`permanent_upazila`,`permanent_distric`, `reg_student_guardian_information`.`guardian_name`,`guardian_house_name`,`guardian_village`,`guardian_po`, `guardian_postCode`,`guardian_upazila`, `guardian_distric`, `relation_with_student`,`guardian_contact`,`guardian_email`,`reg_student_acadamic_information`.`admission_disir_class`, `admission_disir_group`,`regular_iregular`, `caues`,`session2`,`tc_orderNo`,`date`,`add_class`.`class_name`,`add_group`.`group_name` FROM `reg_student_personal_info` INNER JOIN reg_student_address_info ON `reg_student_personal_info`.`id`=`reg_student_address_info`.`id` INNER JOIN reg_student_guardian_information ON `reg_student_personal_info`.`id`=`reg_student_guardian_information`.`id` INNER JOIN reg_student_acadamic_information ON `reg_student_personal_info`.`id`=`reg_student_acadamic_information`.`id` INNER JOIN reg_student_previous_result ON `reg_student_personal_info`.`id`=`reg_student_previous_result`.`id` INNER JOIN add_class ON `reg_student_acadamic_information`.`admission_disir_class`=`add_class`.`id` INNER JOIN add_group ON `reg_student_acadamic_information`.`admission_disir_group`=`add_group`.`id` WHERE `reg_student_personal_info`.`id`='".$_GET["formid"]."'";
    ...
    {
        $select_student="SELECT `reg_student_personal_info`.`id`,`addmission_date`,`student_name`,`father_name`,`mother_name`,`gender`,`date_of_brith`,`religious`,
`meritial_status`,`blood_group`,`nationality`,`contact_no`,`email`,`reg_student_address_info`.`present_house_name`,`present_village`,`present_PO`,`present_post_code`,`present_upazila`, 
 `present_distric`,`permanent_house_name`,`permanent_village`, `permanent_PO`,`permanent_post_code`,`permanent_upazila`,`permanent_distric`,
 `reg_student_guardian_information`.`guardian_name`,`guardian_house_name`,`guardian_village`,`guardian_po`, `guardian_postCode`,`guardian_upazila`,
 `guardian_distric`, `relation_with_student`,`guardian_contact`,`guardian_email`,`reg_student_acadamic_information`.`admission_disir_class`, 
 `admission_disir_group`,`regular_iregular`, `caues`,`session2`,`tc_orderNo`,`date`
 FROM `reg_student_personal_info`  
 INNER JOIN  reg_student_address_info ON `reg_student_personal_info`.`id`=`reg_student_address_info`.`id` 
 INNER JOIN  reg_student_guardian_information ON `reg_student_personal_info`.`id`=`reg_student_guardian_information`.`id` 
 INNER JOIN  reg_student_acadamic_information ON `reg_student_personal_info`.`id`=`reg_student_acadamic_information`.`id` 
 WHERE `reg_student_personal_info`.`id`='".$_GET["formid"]."'";
  ...
  <body>
    ...
    <table align="center" class="table table-responsive bg-info" style="border:1px #CCCCCC solid; margin-top:30px; color: #000;">
            ...
            <?php  } ?>  /><span class="glyphicon glyphicon-warning-sign form-control-feedback"></span></div>
               ...
               <tr>
                <td align="right"><span class="text-info"><strong>Religion &nbsp;:</strong></span></td>
                <td><div class="col-md-6">
                <select class="form-control" name="religious">
                    <?php if (isset($check_Student)) {?>
                <option><?php echo $fetch_Student[religious];?></option>
            <?php  } ?> 
     ...
     <!--       <tr>
		    ...
		    <tr>
                ...
                <td><div class="col-md-6"><input type="email" placeholder="Example@mail.com" name="Email" class="form-control"  /></div>
                </td>
            </tr>
		  ...
		  <tr>
            ...
            <tr>
                ...
                <td>House No./Name.</td>
                <td><input type="text" name="prehouseno" id="prehouseno"  class="form-control" <?php if (isset($check_Student)) {?>
                value='<?php echo $fetch_Student[present_house_name];?>'
            <?php  } ?>  ></input></td>
                 <td>VILL.</td>
                <td><input type="text" name="previlll"  id="previlll" class="form-control" <?php if (isset($check_Student)) {?>
                value='<?php echo $fetch_Student[present_village];?>'
            <?php  } ?>  ></input></td>
                 <td>PO.</td>
                <td><input type="text" name="prepo" id="prepo" class="form-control" <?php if (isset($check_Student)) {?>
                value='<?php echo $fetch_Student[present_PO];?>'
            <?php  } ?>  ></input></td>
            </tr>
            <tr>
                 <td>Post Code.</td>
                <td><input type="text" name="prepostcode" id="prepostcode" class="form-control" <?php if (isset($check_Student)) {?>
                value='<?php echo $fetch_Student[present_post_code];?>'
            <?php  } ?>  ></input></td>
                 <td>Upazilla.</td>
                <td><input type="text" name="preupazilla" id="preupazilla" class="form-control" <?php if (isset($check_Student)) {?>
                value='<?php echo $fetch_Student[present_upazila];?>'
            <?php  } ?>  ></input></td>
                 <td>Distric.</td>
                <td><input type="text" name="predistric" id="predistric" class="form-control"<?php if (isset($check_Student)) {?>
                value='<?php echo $fetch_Student[present_distric];?>'
            <?php  } ?>  ></input></td>
            </tr>
              <tr>
 ...
 <input type="checkbox"   id="check" onclick="sameAddress()" style="height: 20px; width: 20px;"> </input>
      ...
      If both address are same, Click the check box.
            ...
            <tr>
                ...
                <td>House No./Name.</td>
                <td><input type="text" name="parhose" id="parhose" class="form-control"<?php if (isset($check_Student)) {?>
                value='<?php echo $fetch_Student[permanent_house_name];?>'
            <?php  } ?>  ></input></td>
                 <td>VILL.</td>
                <td><input type="text" name="parvill" id="parvill" class="form-control"<?php if (isset($check_Student)) {?>
                value='<?php echo $fetch_Student[permanent_village];?>'
            <?php  } ?>  ></input></td>
                 <td>PO.</td>
                <td><input type="text" name="parpo" id="parpo" class="form-control" <?php if (isset($check_Student)) {?>
                value='<?php echo $fetch_Student[permanent_PO];?>'
            <?php  } ?>  ></input></td>
            </tr>
            <tr>
                 <td>Post Code.</td>
                <td><input type="text" name="parpostcode" id="parpostcode" class="form-control" <?php if (isset($check_Student)) {?>
                value='<?php echo $fetch_Student[permanent_post_code];?>'
            <?php  } ?>  ></input></td>
                 <td>Upazilla.</td>
                <td><input type="text" name="parupazilla"  id="parupazilla" class="form-control"<?php if (isset($check_Student)) {?>
                value='<?php echo $fetch_Student[permanent_upazila];?>'
            <?php  } ?>  ></input></td>
                 <td>Distric.</td>
                <td><input type="text" name="pardistric" id="pardistric" class="form-control"<?php if (isset($check_Student)) {?>
                value='<?php echo $fetch_Student[permanent_distric];?>'
            <?php  } ?>  ></input></td>
            </tr>
            </table>
            <table align="center" class="table table-responsive bg-info" style="border:1px #CCCCCC solid; margin-top: -20px;"> 
            ...
            <tr>
                ...
                value='<?php echo $fetch_Student[guardian_name];?>'
            <?php  } ?>  ></input></div></td>
            </tr>
             ...
             <tr>
                ...
                value='<?php echo $fetch_Student[guardian_contact];?>'
            <?php  } ?>  ></input></div></td>
            </tr>
<tr>
                ...
                value='<?php echo $fetch_Student[guardian_email];?>'
            <?php  } ?>  ></input></div></td>
            </tr>
            <tr>
                ...
                value='<?php echo $fetch_Student[relation_with_student];?>'
            <?php  } ?>  ></input></div></td>
            </tr>
            ...
            <?php  } ?>  ></input></td>
                ...
                <td colspan="6">
				   <div class="col-lg-6 col-md-6"> 
					...
					<?php if (isset($check_Student)) {?>
					<option><?php echo $fetch_Student[session2]?></option>
					<?php } else {?>
						<!--<option>Select One</option>
						        <?php // } ?>
								  <?php 
							...
							<option>Select One</option>
								...
								<option><?php print $year-1;?>-<?php print substr($year,2);?></option>
...
<!--		   
            ...
            <tr>
                ...
                <img src="../OnlineRegistration/img/<?php echo $fetch_Student[0]?>.jpg" height='120' width='130'/> 
