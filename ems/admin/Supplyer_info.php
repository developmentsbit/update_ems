...
if(isset($_POST['add']))
{
		...
		$id=$db->withoutPrefix('supplier_info','id','S','5');

		if(!empty($Name))
		{
			$query="INSERT INTO `supplier_info`(`id`,`sl`,`name`,`address`,`phone`) VALUES('$id','$index','$Name','$Address','$Phone')";
...
if(isset($_POST['Update']))
	{
		...
		{
			$query="REPLACE INTO `supplier_info`(`id`,`sl`,`name`,`address`,`phone`) VALUES('$id','$index','$Name','$Address','$Phone')";
			$result=$db->link->query($query);
			if($result)
			{
			
				echo "<script>alert('Update Successfully')</script>";
				print "<script>location='Supplyer_info.php'</script";
			}
		}
		else
		{
...
if(isset($_POST['View']))
	{
		$query="SELECT * FROM supplier_info ORDER BY `sl` ASC ";
...
//link edit data...................................	
	...
	if(isset($_GET['edit']))
	{
		...
		$query="SELECT * FROM `supplier_info` WHERE `id`='$src_text'";
...
//end link edit data..........................
	...
	if(isset($_GET['dlt']))
	{
		...
		$query="DELETE FROM `supplier_info` WHERE `id`='$linid'";
