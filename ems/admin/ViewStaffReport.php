...
<table width="770"  align="center" style="border:1px #000 solid; height: 30px; margin-top:10px;" >
		<tr>	
				<td align="center" bgcolor="#f4f4f4">
							<h3 style="padding: 0px; margin: 0px; ">Staff's Information</h3>
				</td>
		</tr>
</table>
...
<?php
		  $sql="SELECT `teachers_name`,`designation`,`mobile_no`,`present_address`,`gender`,`email`,`teachers_id` FROM `teachers_information` WHERE `Type`='Stuff' order by `custom_index` ASC";
...
?>
		<tr>
			...
			<td style="border-bottom: 1px #000 solid;"><?php print $fetch_Info[0]; ?></td>
			<td style="border-bottom: 1px #000 solid;"><?php print $fetch_Info[1]; ?></td>
			<td style="border-bottom: 1px #000 solid;"><?php print $fetch_Info[2]; ?></td>
			<td style="border-bottom: 1px #000 solid;"><?php print $fetch_Info[3]; ?></td>
	
			
			
			<td style="border-bottom: 1px #000 solid;"><img  src="../other_img/<?php print $fetch_Info[6]; ?>.jpg" style="height: 80px; width: 80px;"></td>
