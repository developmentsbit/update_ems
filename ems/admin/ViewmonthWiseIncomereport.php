...
<?php
 		...
 		{
 					$yrar=$_POST['year'];
 			print "<script>location='monthlyOthersIncmeReport.php?year=$yrar'</script>";
 		}
?>
<!DOCTYPE html>
<html lang="en">
  <head>
	  ...
	  <title>Yearly Other's Collection </title>
     ...
     <form method="post">
     		<table class="table table-bordered" style="max-width: 800px; " align="center"> 
     			<tr>	
     				<td colspan="2" align="center"><h3>Yearly month wise Other's Income Report</h3></td>
