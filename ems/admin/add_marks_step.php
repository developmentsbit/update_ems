...
function AddMark(tos,froms){
		...
		if(className != "Select One" && groupname != null && examtype != null && session !="Select Session")
		{
			...
			$.ajax({
				url:"AddMarks.php",
				type:"POST",
				data :{className:className,groupname:groupname,examtype:examtype,subject_type:subject_type,sub_name:sub_name,part_name:part_name,session:session,addMarks:addMarks,toss:toss,fromss:fromss,section:section},
				cache:false,
            ...
            <div class="col-md-8 col-md-offset-2" id="AddMarksStep1"><br/> <br/>
                ...
                <tr>
                  ...
                  <tr>
                        ...
                        <td><div class="col-md-8">
                        <select class="form-control" id="section" name="section" style="width:280px; border-radius:0px;">
                        </select>
                        </div>
                        </td>
                </tr>
