							...
							<tr>
								<td align="right" colspan="10">
									<input type="button" onclick="return creatAdmin()" class="btn btn-success btn-sm" style="width:120px;" value="Creat" />
										<input type="button" class="btn btn-danger btn-sm" style="width:120px;" onclick="return deleteFunction()" value="Delete" />
											<input type="submit" class="btn btn-info btn-sm" style="width:120px;" value="Represh" />								
										</td>
							</tr>
							<?php 
									while($fetchSql=$resultSql->fetch_array()){
							...
							<table class="table table-responsive table-hover table-bordered "> 
									...
									<tr>
											<td colspan="4" align="center">
												...
												<center><label>  <input type="text" name="txtSearch" class="form-control" placeholder="Enter Student ID" id="stdID"></label><label> <input type="button" name="btnsearch" value="Search" class="btn btn-success" style="margin-left:10px;" onclick="return searchStudent()"></label> </center>
