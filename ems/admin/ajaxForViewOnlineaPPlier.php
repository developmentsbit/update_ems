...
<!-- 	<img src="../other_img/<?php print $_POST['getId']?>.jpg" height="156" width="180" /> -->
	...
	<img src="../OnlineRegistration/img/<?php print $_POST['getId']?>.jpg"  style="width: 80px; height: 100px " />
</span>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#99CCCC" >
    ...
    <table>
        ...
        <td colspan="2" bgcolor="#FFFFFF"><span style="padding-left: 10px; font-size: 14px;">
          ...
          <a href="../OnlineRegistration/img/<?php print $_POST['getId']?>tc.jpg" target="_blank" class="print">View</a>

          <?php
                $pathdocument=$_POST['getId']."tc.jpg";
                if (file_exists('../OnlineRegistration/img/'.$pathdocument)) 
                {
