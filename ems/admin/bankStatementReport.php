...
<form method="get"  action="ViewbankStatement.php">

  	  <div class="col-sm-12 col-xs-12" style="margin-top: 30px;">

  <div class="panel panel-default" style="border-radius: 0px;">
  <div class="panel-heading" style="font-size: 16px; color: #16a085; text-transform: uppercase;"><b>Bank Statement</b></div>
  <div class="panel-body">
   ...
   <div class="form-group">
    <label > Select Bank Account Number</label>
    <select class="form-control" name="accountNumber" style="height: 40px; border-radius: 0px;">
	  ...
	  {
	  		?>
	  	<option value="<?php print $fetch_id['account_number'];?>"><?php print $fetch_id['bank_name']; ?>-><?php print $fetch_id['account_number']; ?></option>
	  		<?php
	  }
	  ?>
