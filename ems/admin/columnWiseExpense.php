...
<html lang="en">
  <head>
    ...
    <title>Column Wise Expense Report</title>
...
function check_availability()
{
  ...
  <body>
  	<form name="teacherinfo" action="expanseReportColumnWise.php" method="get"  enctype="multipart/form-data" class="form-horizontal marksEditEntry" >
            <div class="col-md-8 col-md-offset-2" id="AddMarksStep1"><br/> <br/>
                <span class="glyphicon glyphicon-arrow-right text-justify text-uppercase text-warning" style="font-weight: bold; padding-top: 15px; font-size: 18px;"><strong style="padding-left:5px; text-transform: capitalize;">Column Wise Expense Report</strong></span><br/>
