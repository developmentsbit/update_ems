...
function check_availability()
{
  ...
  <body>
  	<form name="teacherinfo" action="othersIncomeReportColumnWise.php" method="get"  enctype="multipart/form-data" class="form-horizontal marksEditEntry" >
            <div class="col-md-8 col-md-offset-2" id="AddMarksStep1"><br/> <br/>
                <span class="glyphicon glyphicon-arrow-right text-justify text-uppercase text-warning" style="font-weight: bold; padding-top: 15px; font-size: 18px;"><strong style="padding-left:5px; text-transform: capitalize;">Others Income Report </strong></span><br/>
