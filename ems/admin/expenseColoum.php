<?php
	...
	$fetch[5]="";
	$prefix=date("y"."m"."d");
	$fetch[0]=$db->withoutPrefix('expense_coloumn_setup','id',"00".$prefix,'10');
...
if(isset($_POST['add']))
	{
		...
		$sl=$db->escape($_POST['sl']);
		//print_r($exploide_gropu);
		
		if(!empty($id) && !empty($year) && !empty($title) )
		{
			$query="INSERT INTO `expense_coloumn_setup` VALUES ('".$fetch[0]."','$title','$year','$sl')";
...
if(isset($_POST['Delete']))
	{
		...
		$fetch[0]=$db->withoutPrefix('expense_coloumn_setup','id',"00".$prefix,'10');
		print "<script>location='expenseColoum.php'</script>";
...
if(isset($_POST['Update']))
	{
		...
		if(!empty($id) && !empty($year) && !empty($title) )
		{
			$query="REPLACE  INTO `expense_coloumn_setup` VALUES ('".$_POST["id"]."','$title','$year','$sl')";
			$resultisnsert=$db->update_query($query);
			//print_r($query);
				$src_text=$db->escape($_POST['id']);
		$query="SELECT * FROM `expense_coloumn_setup` WHERE `id`='".$_POST["id"]."'";
...
//view data...............................	
	if(isset($_POST['View']))
	{
        ...
        $table.="<tr class='warning' >"."<td align='left' colspan='7'>"."<a href='expenseColoum.php' class='btn btn-primary'>"."<span class='link text-center'>Back<span>"."</a>"."<span class='text-success' style='font-size:18px; padding-left:380px; font-weight:blod;'>Show All </span>"."</td>"."</tr>";
			
					
				$table.="<tr>"."<td>Name </td>"."<td>Year</td><td>SL</td>"."<td>Action</td>"."</tr>";	
						...
						$table.="<td>";
						$table.="<a href='?edit=$fetch_all[0]'class='btn btn-primary'onclick='return confirm_click()' style='width:80px'>Edit</a>"."</td>";
...
//link edit data...................................	
	...
	if(isset($_GET['edit']))
	{
		...
		$queryg="SELECT * FROM `expense_coloumn_setup` WHERE `id`='".$_GET["edit"]."'";
...
//end link edit data..........................
	...
	if(isset($_GET['dlt']))
	{
		...
		$query="DELETE FROM `expense_coloumn_setup` WHERE `id`='$linid'";
		$delete=$db->delete_query($query);
...
?>
  	...
  	<table align="center" class="table table-responsive box" style="border:1px #CCCCCC solid; margin-top:30px; color: #000;">
  			<tr>
  				<td bgcolor="#f4f4f4"   class="warning" colspan="4" bgcolor="#dddddd"  align="center"><span style="font-size:22px; color:#333; display:block;">Expense Column Setup </span> </td>
  			</tr>
			...
			<tr>
				...
				<td class="info">
					<div class="col-lg-12 has-warning">
						...
						<input type="text"  placeholder="1" class="form-control" name="sl" value="<?php echo $fetch[3];?>"  style="border-radius:0px;"/>
