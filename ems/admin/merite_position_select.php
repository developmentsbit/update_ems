            ...
            <div class="col-md-10 col-md-offset-1"  style="border:2px #CCCCCC solid; margin-top:10px;"><br/> <br/>
                ...
                <table cellpadding="0" cellspacing="0"  class="table table-responsive table-hover " style="margin-top:0px;">					
							...
							<tr style="border:1px #CCCCCC solid" class="warning">
									...
									<td align="center" colspan="3"><span class="text-justify text-info" style="font-size:14px;"><strong>  	Session 	: 	<?php if($resultSql){ echo $session;}else {echo "";}?> </strong></span></td>
									<td align="right" colspan="4"></td>
							</tr>
							<tr class="" style="border:1px #CCCCCC solid">
									<td colspan="10" align="center"><span class="text-justify text-danger" style="font-size:16px;"><strong>  Merit List </strong></span> </td>
							</tr>
