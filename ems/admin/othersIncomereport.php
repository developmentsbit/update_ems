...
<td style="border-bottom:1px solid #333333"></td>
  ...
  <table  width="960"  border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"  align="center" style=" margin-top: 20px;">
        ...
        <tr>
            <td align="center" style="border-bottom: 1px #000 solid; " colspan="2"><h3>  Others Income - <?php print $_GET["year"]; ?></h3>
            ...
            <td align="center"style="border-right:1px #000 solid; " >
                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style=" border-left: 1px #000 solid;border-bottom: 1px #000 solid; text-align: center; width: 150px;"> Date</td>

                                <td style=" border-left: 1px #000 solid;border-bottom: 1px #000 solid; text-align: center;"> Details</td>
                    <?php
$query="SELECT * FROM `income_expense_title` WHERE `type`='Income' ORDER BY `index` ASC";
...
WHERE `type`='Income' and `other_income`.`date`='$date' ORDER BY `index` ASC";
 ...
 if(isset($_GET["monthID"]))
      ...
      if(isset($_GET["SelectYear"]))
    {
      ...
      $y=$_GET["SelectYear"];
        ...
        $totalAmunt="SELECT * FROM `other_income` WHERE `title`='".$fetch_all[0]."' AND  `id`='".$fetch_Class[0]."' AND `date` like '%$y%'";
    }
...
WHERE `type`='Income' and `other_income`.`date` LIKE '%$mo%' GROUP BY `income_expense_title`.`id` ORDER BY `index` ASC";
 ...
 $totalAmunt="SELECT SUM(`amount`) FROM `other_income` WHERE `title`='".$fetch_all[0]."' AND `date` LIKE '%$mo%'";
      ...
      if(isset($_GET["SelectYear"]))
    {
      ...
      $y=$_GET["SelectYear"];
      $mo=$_GET["year"].'-'.$_GET["monthID"];
 $totalAmunt="SELECT SUM(`amount`) FROM `other_income` WHERE `title`='".$fetch_all[0]."' AND `date` LIKE '%$y%'";
