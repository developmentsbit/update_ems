...
error_reporting(1);
	...
	$db = new database();
		...
		if(isset($_POST["ResultGenerate"])){
			...
			if(isset($classID) and $classID != "Select Class" and isset($examtype) and $examtype != "Select Exam Name"  and isset($stdRoll) and !empty($stdRoll)){
					print "<script>location='cover_page.php?clID=$classID[0]&exId=$examtype[1]&stdRoll=$stdRoll&tn=$teacherName&tp=$teachersPhone'</script>";
			}else{
  ...
  <body>
  	<form name="teacherinfo" action="" method="post"  enctype="multipart/form-data" class="form-horizontal " >
            <div class="col-md-8 col-md-offset-2" id="AddMarksStep1"><br/> <br/>
                <span class="glyphicon glyphicon-arrow-right text-justify text-uppercase text-warning" style="font-weight: bold; padding-top: 15px; font-size: 18px;"><strong style="padding-left:5px">View Cover Page  </strong></span><br/>
      ...
      <!--                  <td><div class="col-md-8"><select name="groupname" id="groupname" class="form-control">-->
      ...
      <!--              </tr>-->
				    ...
				    <tr>
					 ...
					 <tr>
                        <td><strong><span class="text-success" style="font-size: 15px;">Class Teacher Name</span></strong></td>
                        <td><div class="col-md-8">
								<input type="text" autocomplete="off" name="teacherName" class="form-control" id="teacherName" placeholder="Teacher's Name"/>
                    ...
                    <tr>
                        <td><strong><span class="text-success" style="font-size: 15px;">Teacher's Phone</span></strong></td>
                        <td><div class="col-md-8">
								<input type="text" autocomplete="off" name="teachersPhone" class="form-control" id="teachersPhone" placeholder="Teacher's Phone"/>
					 ...
					 <tr>
                        ...
                        <td><div class="col-md-8">
								<input type="text" autocomplete="off" name="stdId" class="form-control" id="stdId" placeholder='Student Roll'/>
                ...
                <tr><td colspan="2" align="center"><input type="submit" name="ResultGenerate" value="Show Admitcard" class="btn btn-danger btn-md" style="width: 180px" formtarget="_blank"></input>
