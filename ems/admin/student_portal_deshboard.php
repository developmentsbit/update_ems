   ...
   if($checked_query)
    ...
    if(isset($_POST['add']))
    {
      ...
      $about_school=$db->escape($_POST['Contact_Textarea']);
    	...
    	{
    	$insert="INSERT INTO `student_portal_dashboard` VALUES('1','Online Applicant','$about_school')";
  ...
  if(isset($_POST['Update']))
    {
      ...
      if(!empty($about_school))
      {
      	$insert="REPLACE INTO `student_portal_dashboard` VALUES('1','Online Applicant','$about_school')";
...
if(isset($_POST['Delete'])){
	$Delete="DELETE FROM `student_portal_dashboard` WHERE `id`='1'";
...
<body>
  ...
  <div class="panel-heading" style="font-size: 16px; color: #16a085; text-transform: uppercase;"><b>Student Portal Dashboard</b></div>
