            ...
            <div class="col-md-10 col-md-offset-1 "  style="border:2px #CCCCCC solid; margin-top:10px;">
                ...
                <table cellpadding="0" cellspacing="0"  class="table table-responsive table-hover " style="margin-top:0px;">					
							...
							<tr style="border:1px #CCCCCC solid">
									...
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6"> <?php echo "<span class='label label-danger label-as-badge'> ".$sl.".</span>&nbsp;". "(&nbsp;".$fetch_roll["class_roll"]."&nbsp) &nbsp".$fetch_name["student_name"]."&nbsp";?> ( <?php  $subsubCod="SELECT `gnerate_marks`.`subjectID`,`add_subject_info`.`subject_code` FROM `gnerate_marks` 
