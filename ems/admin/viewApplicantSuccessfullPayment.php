<?php
	...
	if($query)
	{
		...
		if(isset($_GET['del_ID']))
		{
				...
				print "<script>location='viewApplicantSuccessfullPayment.php'</script>";
...
<form method="POST">
				...
				<td>
						...
						<div style="float: left; clear: right; text-align: center; width: 70% ">   
							   ...
							   <li style="list-style: none; ">
							    ...
							    <li><b> Successful Payment Report</b></li>
	...
	<table class="table table-bordered table-hover">
							...
							<tr>
								...
								<td align="center">Guardian's Number</td>
							...
							<?php 
									$sqlfordetails  = "SELECT `form_ID`,`student_name`,`phone`,`class`,`bKash_number`,`TrxId`,`date`,`time` FROM `student_form_info` where `status`='1' order by `form_ID` ASC ";
									//print $sqlfordetails;
							...
							<td align="center"><input type="checkbox" name="form_ID[]" value="<?php print $fetchfordetails['form_ID']?>"></input> </td>
							    ...
							    <td align="center"><?php echo $fetchfordetails["form_ID"];?></td>
							    <td align="center"><?php $x=explode("and",$fetchfordetails["class"]); print $x[1]?></td>
	...
	<a href="https://alhelalacademy.edu.bd/high/OnlineRegistration/viewDetails.php?id=<?php print $fetchfordetails['form_ID']?>" class="btn btn-success" target="_blank" > View </a><br><br>
	<a href="https://alhelalacademy.edu.bd/high/OnlineRegistration/admit/admit.php?adminprint=<?php print $fetchfordetails['form_ID']?>" class="btn btn-success" target="_blank" > Admit Card </a><br><br>
<a href="StudentApproveList.php?formid=<?php print $fetchfordetails['form_ID']?>" formtarget="blank"  class="btn btn-success" >Registration</a><br><br>
