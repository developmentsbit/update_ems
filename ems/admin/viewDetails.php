...
<table width="927" height="197" border="1" cellpadding="0" cellspacing="0" align="center" style="margin-top:10px;">
  ...
  <tr >
    ...
    <div style="float:left; clear:right"><img src="all_image/logoSDMS2015.png" style="height:80px; width:80px; " /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
    <div style="float:left">
            ...
            ?></span><br/></strong>
    <strong><span style="font-size:16px;" class="text-success">Students' Info </span></strong></div></div>  </td>
  </tr>
  <tr align="">
    ...
    <td width="190" height="21" align="left" style="padding-left:20px; font-size:16px;">ID No. </td>
      ...
      ?></td>
        <td width="210" rowspan="5" align="center" style="padding-left:20px; font-size:16px; vertical-align:middle;"> <?php
         $src = "../other_img/$fetchDeatials[student_id].jpg";
                                ...
                                if($fetchDeatials["gender"] =="Male"){
                                    ...
                                    ?>
                                    <img src="../other_img/<?php echo $fetchDeatials["student_id"] ?>.jpg"  class="img-responsive img-thumbnail"    border="2" style="margin-top:8px;border:0px;  height:150px; width:120px" alt='<?php echo $fetchDeatials["student_name"] ?>'/>
...
<table align="center" width="900">
    ...
    <tr>
        ...
        <td>:</td>
        <td> <?php if (isset($check_Student)) {
            echo $fetch_Student[2];
            } ?>  </td>
    </tr>
   ...
   <tr>
     ...
     <tr>
      ...
      <tr>
        ...
        <td>:</td>
        <td> <?php if (isset($check_Student)) {
            echo $fetch_Student[12];
            } ?>  </td>
    </tr>

       <tr>
        <td colspan="3">STUDENT'S ADDRESS</td>
       ...
       <tr>
        ...
        <td> <?php if (isset($check_Student)) {
            ...
            <tr>
                <td ><STRONG class='text-info'>House No./Name.</STRONG> </td>
                <td>:</td>
                <td> <?php if (isset($check_Student)) {
                    echo $fetch_Student[37];
         ...
         <tr>
            ...
            <tr>
                <td colspan="3"  class='text-info'> 
                    <STRONG><span>Guardian's Name:</STRONG></span></td>
            </tr>
