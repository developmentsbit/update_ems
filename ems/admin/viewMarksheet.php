...
// $bar=$fetch_r["student_name"].$fetch_r["class_name"].$fetch_r["STD_ID"]. $fetch_r["std_roll"];
$bar=$fetch_r["STD_ID"];
$Bar = new Picqer\Barcode\BarcodeGeneratorHTML();
$code = $Bar->getBarcode($bar, $Bar::TYPE_CODE_128);
      ...
      <tr>
        <td><img src="all_image/school_mark_sheetSDMS2015.jpg" height="1530" width="1100"/>
            ...
            style="margin-top:-1300px; background:none; position:relative;">
              <tr>
                <td width="888" height="92" align="left" valign="bottom">
					 ...
					 <tr>
                      <td width="100%" colspan="3" align="center"><span><strong style="font-size:22px;"><?php
						...
						$resultName = $db->select_query($examName);
							...
							echo $fetchName[0].'-'.date('Y');
					  ?></strong> </span></td>
                   
                    </tr>
                      <tr>
                            <td colspan="3" align="right" > <span style="width:300px; font-size:7px;"> <?php print $code;?></span>  </td>
                        </tr>
				...
				<tr>
                    ...
                    <!--  <td height="29" colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0">-->
                    <!--      <tr>-->
                    <!--        <td width="28%" height="39" class="style21">Merit Position </td>-->
                    <!--        <td width="2%" class="style21">:</td>-->
                    <!--        <td width="23%" class="style21"> <?php if(isset($fetch_r)){ echo $fetch_r["meritPosition"];}else {echo "";}?></td>-->
                    <!--        <td width="20%" class="style21">&nbsp;</td>-->
                    <!--        <td width="2%" class="style21">&nbsp;</td>-->
                    <!--        <td width="25%" class="style21">&nbsp;</td>-->
                    <!--      </tr>-->
                            ...
                            <td style="border-right: 1px #000  solid; border-bottom: 1px #000  solid; text-align: center; width: 50px; height: 40px;">Sub.  Code</td>
                             ...
                             <td style="border-bottom: 1px #000  solid;border-right: 1px #000  solid; text-align: center; width: 47px;">Cre.</td>
                                <td style="border-bottom: 1px #000  solid;border-right: 1px #000  solid; text-align: center;width: 47px;">MCQ</td>
                                 <td style=" width: 47px; border-bottom: 1px #000  solid;border-right: 1px #000  solid; text-align: center;"> Cont. Asses.</td>
                                
                             
                             <td style=" width: 47px;border-bottom: 1px #000  solid;border-right: 1px #000  solid; text-align: center;">Obtained Marks</td>
                            <td style=" width: 47px; border-bottom: 1px #000  solid;border-right: 1px #000  solid; text-align: center;">Highest Mark</td>
...
$maxmarks=$db->select_query("SELECT MAX(`obtainMark`) FROM `marksheet` WHERE `marksheet`.`ClassId`='$clId' AND `marksheet`.`GroupID`='$gpId' AND `marksheet`.`ExamId`='$examId' 
AND `marksheet`.`Session`='$Session' AND `marksheet`.`SubjectPartID`='$fetchSubjectPart[part_id]'");
$fetchMaxMarks=$maxmarks->fetch_array();
      ...
      ?>
             ...
             <tr>
                            ...
                            <td style="border-bottom: 1px #000  solid;border-right: 1px #000  solid; text-align: center; height: 30px;"><?php echo $fetchSubjectPartmarks[7]?></td>
                             <td style="border-bottom: 1px #000  solid;border-right: 1px #000  solid; text-align: left;text-transform: uppercase;">&nbsp; <?php echo $fetchSubjectPartmarks[8]?></td>
                            ...
                            <td style="border-bottom: 1px #000  solid;border-right: 1px #000  solid; text-align: center;"><?php echo $fetchSubjectPartmarks[1]?></td>
                             ...
                             <td style="border-bottom: 1px #000  solid;border-right: 1px #000  solid; text-align: center;"><?php echo $fetchSubjectPartmarks[4]?></td>
                                   <td style="border-bottom: 1px #000  solid;border-right: 1px #000  solid; text-align: center;">
                                      <?php print $fetchMaxMarks[0];?>
...
$maxmarks=$db->select_query("SELECT MAX(`obtainMark`) FROM `marksheet` WHERE `marksheet`.`ClassId`='$clId' AND `marksheet`.`GroupID`='$gpId' AND `marksheet`.`ExamId`='$examId' 
AND `marksheet`.`Session`='$Session' AND `marksheet`.`SubjectId`='$fetchsubject[SubjectId]'");
$fetchMaxMarks=$maxmarks->fetch_array();
...
$toalObtainMark=$toalObtainMark+$fetchSubjectPartmarks[4];
  ...
  <tr>
                            ...
                            <td style="border-bottom: 1px #000  solid;border-right: 1px #000  solid; text-align: center;"><?php echo $fetchSubjectPartmarks[1]?></td>
                             ...
                             <td style="border-bottom: 1px #000  solid;border-right: 1px #000  solid; text-align: center;"><?php echo $fetchSubjectPartmarks[4]?></td>
                              <td style="border-bottom: 1px #000  solid;border-right: 1px #000  solid; text-align: center;"> <?php print $fetchMaxMarks[0]; ?></td>
                              <td style="border-bottom: 1px #000  solid;border-right: 1px #000  solid; text-align: center;"><?php echo $fetchSubjectPartmarks[5]?></td>
...
echo $toalSubjectMarks;
    ...
    ?></b></td>
    <td colspan="4" style="border-bottom: 1px #000  solid;border-right: 1px #000  solid; text-align: center;"> Total Obtained Marks</td>
...
?>
              ...
              <tr>
                  <td>
                       <table width="100%" cellpadding="0" cellspacing="0" >
                           <tr>
                              <td style="border-left:1px #000 solid; border-top:1px #000 solid; border-right:1px #000 solid;  " colspan="3" width="45%" align="left"height="30" >&nbsp;<b style="font-size:18px;"> Duration: </b> </td>
                           </tr>
                           <tr>
                               <td style="border-left:1px #000 solid; border-top:1px #000 solid; border-right:1px #000 solid; border-bottom:1px #000 solid; " width="45%"> 
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                           <tr>
                                               <td style="border-bottom: 1px #000 solid;border-right: 1px #000 solid; " width="50%" height="30">&nbsp; Total Working Days :</td>
                                               <td style="border-bottom: 1px #000 solid;"> </td>
                                                  ...
                                                  <tr>
                                               <td style="border-bottom: 1px #000 solid;border-right: 1px #000 solid; " width="50%" height="30">&nbsp; Total Present :</td>
                                               <td style="border-bottom: 1px #000 solid;"> </td>
                                            ...
                                            <tr>
                                               <td style="border-right: 1px #000 solid; " width="50%" height="30">&nbsp; Total Absent :</td>
                                               <td style=""> </td>
                               ...
                               <td style=" border-top:1px #000 solid; border-bottom:1px #000 solid;" width="5%" height="30"> </td>
                               <td style="border-left:1px #000 solid; border-top:1px #000 solid; border-right:1px #000 solid; border-bottom:1px #000 solid; ">
                                  <table width="100%" cellpadding="0" cellspacing="0">
                                           <tr>
                                               <td style="border-bottom: 1px #000 solid;border-right: 1px #000 solid; "height="30"  width="50%">&nbsp; Discipline:</td>
                                               <td style="border-bottom: 1px #000 solid;"> </td>
                                                  ...
                                                  <tr>
                                               <td style="border-bottom: 1px #000 solid;border-right: 1px #000 solid; "height="30" width="50%">&nbsp; Behaviour :</td>
                                               <td style="border-bottom: 1px #000 solid;"> </td>
                                            ...
                                            <tr>
                                               <td style=" " width="50%" colspan="2" height="30"> .</td>
                              ...
                              <tr>
                              <td style="border-left:1px #000 solid; border-bottom:1px #000 solid; border-right:1px #000 solid;  " colspan="3" width="45%" align="left"height="30">&nbsp;<b  style="font-size:18px;"> Remarks: </b> </td>
                           </tr>
                       </table>
              ...
              <tr>
				...
				<table width="100%" height="33%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:-180px;">
                    <tr>
                      <td width="25%" height="57" valign="top"><strong style="font-size: 20px;"><p> --------------------</p>Compared by</span></strong></td>
                      
                      <td width="40%" align="center" valign="top" >
                          <strong style="font-size: 20px;"><p> --------------------</p>Class Teacher</span></strong>
                       </td>
                      
                      <td width="25%" align="center" valign="top"><strong style="font-size: 20px;"><p> -------------------------</p>
