   ...
   if(isset($_GET['invoice']))
    {
        ...
        echo "<script>location='viewStudentDueInvoice.php'</script>";
    }  
...
// `id` `` `date`  `roll` `name` `` `` `class_id` `class_name` `due` `` `invoiceExpireDate` `status` `payment_date` `bank_info` ,`updated_at`
                ...
                <tr>
                    ...
                    <td>
                        <a href="student_due_invoice.php?id=<?php echo $fetcharry['student_id'];?>&year=<?php print date('Y')?>&date=<?php echo $fetcharry['date'];?>&clas=<?php echo $fetcharry['class_id'];?>&last_id=<?php echo $fetcharry['invoice_id'];?>" class="btn btn-success" title="Report" target="_blank"> Report</a> <br> <br>
