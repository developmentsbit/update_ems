...
<!-- 
  <li class="dropdown"><a data-toggle="dropdown" class="dropdown-toggle">Student Profile<span class="caret"></span></a>
                  <ul class="dropdown-menu">
                 
                <li><a href="add_period.php" target="ifrmae">Add period</a></li>
                <li><a href="add_babon.php" target="ifrmae">Add bhaban</a></li> 
                <li><a href="add_room.php" target="ifrmae">Add room</a></li> 
                        
                    
                  </ul>
                </li> -->
                <li><a href="viewDetails.php?id=<?php print $_SESSION["useridid"]?>" target="ifrmae">Student Profile</a></li>
                 <li><a href="payment.php" target="ifrmae">Payment </a></li>
               
                <li><a href="admit/admit.php" target="ifrmae">Admit Card</a></li>
