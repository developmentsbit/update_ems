...
if(isset($_POST['add']))
    {
        ...
        @$exploide_gropu=explode("and",$class_section);
         ...
         $prefix=date("y");
    	 $id=$db->withoutPrefix('reg_student_personal_info','id',$prefix,'6');
    	 	
        $passward=mt_rand(100000,999999);
        $_SESSION["password"]=$passward;
      
        

        if(!empty($_POST["studentname"]) && !empty($_POST["gender"]) && !empty($_POST["fathername"]) && !empty($_POST["mothersname"]) && !empty($_POST["GuardianContactNo"]) &&  $stdpic!="" )
        {
                ...
                // $db->link->query("DELETE FROM `reg_student_personal_info` WHERE `id`='".$_SESSION['formid']."'");
                // $db->link->query("DELETE FROM `reg_student_previous_result` WHERE `id`='".$_SESSION['formid']."'");
                // $db->link->query("DELETE FROM `reg_student_address_info` WHERE `id`='".$_SESSION['formid']."'"); 
                // $db->link->query("DELETE FROM `preview_reg_student_guardian_information` WHERE `id`='".$_SESSION['formid']."'");
                // $db->link->query("DELETE FROM `reg_student_acadamic_information` WHERE `id`='".$_SESSION['formid']."'");
                // $db->link->query("DELETE FROM `reg_student_passward` WHERE `id`='".$_SESSION['formid']."'");
     ...
     `date_of_brith`,`religious`,`meritial_status`,`blood_group`,`nationality`,`contact_no`,`email`) VALUES('$id','".$_POST['addmissiondate']."','".$_POST['studentname']."','".$_POST['fathername']."','".$_POST['mothersname']."','".$_POST['gender']."','".$_POST['dateofbrith']."','".$_POST['religious']."','".$_POST['meritelstutas']."','".$_POST['blood']."','".$_POST['Nationality']."','".$_POST['Contactno']."','".date('Y')."')";
       
       @$previousresult_insert_query="INSERT INTO `reg_student_previous_result`(`id`, `psc_board`, `psc_institute`, `psc_registration`, `psc_Year`, `psc_roll`, `psc_group`, `psc_GPA`, `psc_passing_year`) values ('$id','".$_POST['selectClass']."','".$_POST['pscinstitute']."','".$_POST['pscregno']."','".$_POST['pscyear']."','".$_POST['pscroll']."','".$_POST['pscgroup']."','".$_POST['pscgradepoint']."','".$_POST['pscpassingyear']."')";


      @$studentaddress_insert_query="INSERT INTO `reg_student_address_info`(`id`, `present_house_name`, `present_village`, `present_PO`, `present_post_code`, `present_upazila`, `present_distric`, `permanent_house_name`, `permanent_village`, `permanent_PO`, `permanent_post_code`, `permanent_upazila`, `permanent_distric`) VALUES('$id','".$_POST['prehouseno']."','".$_POST['previlll']."','".$_POST['prepo']."','".$_POST['prepostcode']."','".$_POST['preupazilla']."','".$_POST['predistric']."','".$_POST['parhose']."','".$_POST['parvill']."','".$_POST['parpo']."','".$_POST['parpostcode']."','".$_POST['parupazilla']."','".$_POST['pardistric']."')";

        
      @$student_gurdient_informaiton="INSERT INTO `reg_student_guardian_information` (`id`,`guardian_name`,`guardian_house_name`,`guardian_village`,`guardian_po`,`guardian_postCode`,`guardian_upazila`,`guardian_distric`,`relation_with_student`,`guardian_contact`,`guardian_email`) VALUES ('$id','".$_POST['GuardianName']."','".$_POST['grahouseno']."','".$_POST['gravilll']."','".$_POST['grapo']."','".$_POST['grapostcode']."','".$_POST['graupazilla']."','".$_POST['gradistrict']."','".$_POST['RelationWithStudent']."','".$_POST['GuardianContactNo']."','".$_POST['GuardianEmail']."')";

       // echo $student_gurdient_informaiton;

      @$student_academic_information="INSERT INTO reg_student_acadamic_information (id, admission_disir_class, admission_disir_group, regular_iregular, caues, session2, tc_orderNo, `date`) VALUES ('$id','$explode_Class[0]','$exploide_gropu[0]','".$_POST['regularirregular']."','".$_POST['Cause']."','".$_POST['Session1']."','".$_POST['tcorderno']."','".$_POST['academicdate']."')";
        $studnetPasswardInfor="INSERT INTO `reg_student_passward`(`studentId`,`passward`,`status`) VALUES('$id','".$_SESSION["password"]."','Deactive')";
        ...
        $url="www.studentportal.imc.edu.bd/login.php" ;
        
        $msg="Congratulations! ".$_POST['studentname'].". Your Infomation has successfully submitted . Your Roll:".$id. "Password:". $passward." Login Url :".$url;

        $recipient  = "88".$_POST["GuardianContactNo"];     
        $requestType = 'SINGLE_SMS';    
        $messageType = 'TEXT';  
        $sms = new AdnSmsNotification();
        $sms->sendSms($requestType, $msg, $recipient, $messageType);
      print "<script>location='viewDetails.php?id=$id'</script>";
...
if(isset($_POST['Preview']))
    {
      ...
      $db->link->query("DELETE FROM `preview_reg_student_personal_info` WHERE `id`='".$_SESSION['formid']."'");
      $db->link->query("DELETE FROM `preview_reg_student_previous_result` WHERE `id`='".$_SESSION['formid']."'");
      $db->link->query("DELETE FROM `preview_reg_student_address_info` WHERE `id`='".$_SESSION['formid']."'"); 
      $db->link->query("DELETE FROM `preview_reg_student_guardian_information` WHERE `id`='".$_SESSION['formid']."'"); 
      $db->link->query("DELETE FROM `preview_reg_student_acadamic_information` WHERE `id`='".$_SESSION['formid']."'");
      $db->link->query("DELETE FROM `preview_reg_student_passward` WHERE `id`='".$_SESSION['formid']."'");
        ...
        if(!empty($_POST["studentname"]))
        {
                ...
                if(in_array($file_ext,$expensions) == false && $file_size > 360000){
                  print "<script>alert('extension not allowed, and check your image less then 360kb')</script>";
                    ...
                    VALUES ('".$_SESSION['formid']."','".$_POST['addmissiondate']."','".$_POST['studentname']."','".$_POST['fathername']."','".$_POST['mothersname']."','".$_POST['gender']."','".$_POST['dateofbrith']."','".$_POST['religious']."','".$_POST['meritelstutas']."','".$_POST['blood']."','".$_POST['Nationality']."','".$_POST['Contactno']."','".date('Y')."')";
       
      // print $personal_insert_query."<br>";
       
      @$previousresult_insert_query="INSERT INTO `preview_reg_student_previous_result`(`id`, `psc_board`, `psc_institute`, `psc_registration`, `psc_Year`, `psc_roll`, `psc_group`, `psc_GPA`, `psc_passing_year`) values ('".$_SESSION['formid']."','".$_POST['selectClass']."','".$_POST['pscinstitute']."','".$_POST['pscregno']."','".$_POST['pscyear']."','".$_POST['pscroll']."','".$_POST['pscgroup']."','".$_POST['pscgradepoint']."','".$_POST['pscpassingyear']."')";
     // print $previousresult_insert_query."<br>";

        @$studentaddress_insert_query="INSERT INTO `preview_reg_student_address_info`(`id`, `present_house_name`, `present_village`, `present_PO`, `present_post_code`, `present_upazila`, `present_distric`, `permanent_house_name`, `permanent_village`, `permanent_PO`, `permanent_post_code`, `permanent_upazila`, `permanent_distric`) VALUES('".$_SESSION['formid']."','".$_POST['prehouseno']."','".$_POST['previlll']."','".$_POST['prepo']."','".$_POST['prepostcode']."','".$_POST['preupazilla']."','".$_POST['predistric']."','".$_POST['parhose']."','".$_POST['parvill']."','".$_POST['parpo']."','".$_POST['parpostcode']."','".$_POST['parupazilla']."','".$_POST['pardistric']."')";
  // print $studentaddress_insert_query."<br>";
        @$student_gurdient_informaiton="INSERT INTO `preview_reg_student_guardian_information`(`id`, `guardian_name`, `guardian_house_name`, `guardian_village`, `guardian_po`, `guardian_postCode`, `guardian_upazila`, `guardian_distric`, `relation_with_student`, `guardian_contact`, `guardian_email`)  VALUES ('".$_SESSION['formid']."','".$_POST['GuardianName']."','".$_POST['grahouseno']."','".$_POST['gravilll']."','".$_POST['grapo']."','".$_POST['grapostcode']."','".$_POST['graupazilla']."','".$_POST['gradistrict']."','".$_POST['RelationWithStudent']."','".$_POST['GuardianContactNo']."','".$_POST['GuardianEmail']."')";

        //print $student_gurdient_informaiton."<br>";

        @$student_academic_information="INSERT INTO preview_reg_student_acadamic_information (id, admission_disir_class, admission_disir_group, regular_iregular, caues, session2, tc_orderNo, `date`) VALUES ('".$_SESSION['formid']."','$explode_Class[0]','$exploide_gropu[0]','".$_POST['regularirregular']."','".$_POST['Cause']."','".$_POST['Session1']."','".$_POST['tcorderno']."','".$_POST['academicdate']."')";
           // print $student_academic_information."<br>";

            $studnetPasswardInfor="INSERT INTO `preview_reg_student_passward`(`studentId`,`passward`,`status`) VALUES('".$_SESSION['formid']."','123','Deactive')";
    
       //print $studnetPasswardInfor."<br>";
      $strfimg="img/".$_SESSION['formid'].".jpg";
      @move_uploaded_file($_FILES["file"]["tmp_name"],$strfimg);
      @chmod($strfimg,0644);

      $tcimg="img/".$_SESSION['formid']."tc.jpg";
      ...
      @chmod($tcimg,0644);
        ...
        $id=$_SESSION['formid'];
        print "<script>location='preview.php?id=$id'</script>";
...
<body>
  ...
  <label class="checkbox-inline">
  <h3 style="text-shadow:  0px 3px 3px #999;">  <?php print $fetch_school_information['institute_name'] ?></h3>

            
  <h5>          
   	(Student Information Form)</h5>

    <h4>জরুরী প্রয়োজনে যোগাযোগ করুন :  <?php print $fetch_school_information['phone_number'] ?></h4>
    </label >
  </div>
   </div>
  <div class="container" style="">
    ...
    <div class="content_wrapper">
      <div class="tab_content active formediaFrast" style="min-height:550px;max-height:1000px;">
                     ...
                     <div class="form-group">
                        <label >Student's Name :</label><strong class="text-danger"> ** </strong>
                              ...
                              <input type="text"  placeholder="Student's Name"  name="studentname" class="form-control"   <?php if (isset($_POST["studentname"])) {?>
                                    value='<?php echo $_POST["studentname"];?>' <?php  }else { ?>
                                    value='' <?php } ?>  /> 
                      </div>
...
<select class="form-control" name="blood">
 ...
 <div class="form-group" >
  ...
  <input type="text" class="form-control" placeholder="dd-mm-yy" name="dateofbrith" style="height:30px; width:100%; margin-top:5px;" id="example2" <?php if (isset($_POST["dateofbrith"])) {?>
...
<div class="col-lg-12  col-md-12 col-xs-12"  style="padding-top: 10px;">
   ...
   <select name="groupname" id="groupname" class="form-control" style="max-width: 300px;" >
            ...
            <?php  } ?> 
              ...
              <div class="form-group col-lg-4 col-md-4">
                <label >Year :</label><strong class="text-danger"> ** </strong>
       ...
       <label>Guardian's Email :</label>  
        ...
        <div class="form-group col-lg-12 col-md-12  ">
          <p style="text-align: right;">
                        ...
                        &nbsp;&nbsp;
                        <!--<label>-->
                        <!--      <input type="submit" name="Preview" value="Preview" class="btn btn-large btn-success"  -->
