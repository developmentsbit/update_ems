...
use AdnSms\AdnSmsNotification;
    ...
    // $form="select * from student_form_info where form_ID='".$_SESSION['formid']."'";
    // $selectform=$db->select_query($form);
    // $stdinfo=$selectform->fetch_array();
...
if(isset($_POST['add']))
    {
     ...
     `date_of_brith`,`religious`,`meritial_status`,`blood_group`,`nationality`,`contact_no`,`email`) VALUES('".$_SESSION['formid']."','".$_POST['addmissiondate']."','".$_POST['studentname']."','".$_POST['fathername']."','".$_POST['mothersname']."','".$_POST['gender']."','".$_POST['dateofbrith']."','".$_POST['religious']."','".$_POST['meritelstutas']."','".$_POST['blood']."','".$_POST['Nationality']."','".$_POST['Contactno']."','".date('Y')."')";
       
       @$previousresult_insert_query="INSERT INTO `reg_student_previous_result`(`id`, `psc_board`, `psc_institute`, `psc_registration`, `psc_Year`, `psc_roll`, `psc_group`, `psc_GPA`, `psc_passing_year`) values ('".$_SESSION['formid']."','".$_POST['selectClass']."','".$_POST['pscinstitute']."','".$_POST['pscregno']."','".$_POST['pscyear']."','".$_POST['pscroll']."','".$_POST['pscgroup']."','".$_POST['pscgradepoint']."','".$_POST['pscpassingyear']."')";
      ...
      @$student_academic_information="INSERT INTO reg_student_acadamic_information (id, admission_disir_class, admission_disir_group, regular_iregular, caues, session2, tc_orderNo, `date`) VALUES ('".$_SESSION['formid']."','$explode_Class[0]','$exploide_gropu[0]','".$_POST['regularirregular']."','".$_POST['Cause']."','".$_POST['Session1']."','".$_POST['tcorderno']."','".$_POST['academicdate']."')";
        $studnetPasswardInfor="INSERT INTO `reg_student_passward`(`studentId`,`passward`,`status`) VALUES('".$_SESSION['formid']."','".$_SESSION["password"]."','Deactive')";
       ...
       @chmod($tcimg,0644);
        ...
        $url="https://alhelalacademy.edu.bd/OnlineRegistration/login.php?ID=".$_SESSION['formid']."&PW=".$_SESSION["password"];

        $msg="Congratulations! Your admission application is submitted successfully. ".$url;
        ...
        print "<script>location='student_Login_ID_Password.php?id=$id'</script>"; 
...
<body>
  ...
  <h5>          
    (Application Form)</h5>
<!--   <h4 style="color:000; font-weight:bold;">আগামী ০২ জানুয়ারি পর্যন্ত ভর্তি আবেদন করা যাবে।  ০৩ জানুয়ারি সকাল ১০টায় ছাত্রদের এবং ০৪ জানুয়ারি সকাল ১০টায় ছাত্রীদের সাক্ষাৎকার নেওয়া হবে।  ০৫ জানুয়ারি সকাল ১০টায় ভর্তির জন্য নির্বাচিতদের তালিকা প্রকাশ করা হবে।  ০৫ জানুয়ারি থেকে ১০ জানুয়ারি পর্যন্ত ভর্তি হওয়া যাবে। -->
<!--</h4>-->
    <h4>জরুরী প্রয়োজনে যোগাযোগ করুন : ০১৩০৯০৯২৪৩৮, ০১৩০৯১০৬৭১০</h4>
    </label >
  </div>
   </div>
...
GPA :</label>
 ...
 <div class="form-group col-lg-12 col-md-12">
                <label>
<h4 style="color: #ff0000;">Attach Certificate/ Marksheet/ Testimonial/T.C (if any).</h4></label>
<br>
