...
class database {
	...
	public $username="imcedu_imcadmin";
	public $pass="-+bpa4b-4T2e";
	public $db_name="imcedu_result";
	// public $servername="localhost";
	// public $username="holycrescentscho_admin";
	// public $pass="#{Mh54D4QPzS";
	// public $db_name="holycrescentscho_database";
		//public $db_name="newfgcattendnce";
