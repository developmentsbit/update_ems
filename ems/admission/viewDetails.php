...
LEFT JOIN `add_group`  ON  `add_group`.`id`=`reg_student_acadamic_information`.`admission_disir_group` WHERE `reg_student_acadamic_information`.`id`='$id'";
...
.intitle{padding-left:15px; color:#0033CC; font-size:16px; letter-spacing:0.5px;}
.text{padding-left:15px; color:#000000; font-size:16px; }
</style>
...
<table  class="table "  style="background: #fff; width: 750px; border-top:1px #4639E8 solid; height:1000px; font-size:16px; "  border="0" align="center" cellpadding="0" cellspacing="0">
...
<p style="text-align:left;">
 	<h3  style="text-transform:uppercase; font-size: 28px;"><?php print $fetch_school_information['institute_name'] ?></h3>
 </p>
...
<h4>
  ...
  Applicant's ID : <b><?php echo $fetch_result["id"]; ?></b>
	<p> Password : <b><?php echo $fetch_result["passward"]; ?></b>
...
<!-- 	<img src="../other_img/<?php print $_POST['getId']?>.jpg" height="156" width="180" /> -->
	...
	<img src="img/<?php print $_GET['id']?>.jpg"  style="width: 80px; height: 100px " />
</span>
	 ...
	 <table>
      ...
      <td bgcolor="#FFFFFF"><span style="padding-left: 10px; font-size: 14px;"> :</span></td>
        ...
        <td width="550" bgcolor="#FFFFFF">
          ...
          <span style=" padding-left: 10px; font-size: 14px;"><?php echo $fetch_result['addmission_date']; ?>
        </td>
      ...
      <tr>
        ...
        <td  bgcolor="#FFFFFF"><span style="padding-left: 10px; font-size: 14px;">:</span></td>
        <td width="601" bgcolor="#FFFFFF"><span style=" padding-left: 10px; font-size: 14px;"><?php echo $fetch_result["student_name"]; ?></span></td>
        </tr>
       <tr>
        <td width="321"  bgcolor="#FFFFFF"><span style="padding-left: 10px; font-size: 14px;">Father's Name</span></td>
        <td  bgcolor="#FFFFFF"><span style="padding-left: 10px; font-size: 14px;">:</span></td>
        <td width="601" bgcolor="#FFFFFF"><span style=" padding-left: 10px;font-size: 14px;"><?php echo $fetch_result["father_name"]; ?></span></td>
        </tr>
     <tr>
        <td width="321"  bgcolor="#FFFFFF"><span style="padding-left: 10px; font-size: 14px;">Mother's Name</span></td>
        <td  bgcolor="#FFFFFF"><span style="padding-left: 10px; font-size: 14px;">:</span></td>
        <td width="601" bgcolor="#FFFFFF"><span style=" padding-left: 10px; font-size: 14px;"><?php echo $fetch_result["mother_name"]; ?></span></td>
        </tr>
      <tr>
        <td width="321"  bgcolor="#FFFFFF"><span style="padding-left: 10px; font-size: 14px;">Gender</span></td>
        <td  bgcolor="#FFFFFF"><span style="padding-left: 10px; font-size: 14px;">:</span></td>
        <td width="601" bgcolor="#FFFFFF"><span style=" padding-left: 10px;font-size: 14px;"><?php echo $fetch_result["gender"]; ?></span></td>
        </tr>
    ...
    <td width="50%">
     ...
     <tr>
      ...
      <tr>
        ...
        <td  bgcolor="#FFFFFF"><span style=" padding-left: 10px;font-size: 14px;">:</span></td>
        <td width="601" bgcolor="#FFFFFF"><span style=" padding-left: 10px;font-size: 14px;"><?php echo $fetch_result["date_of_brith"]; ?></span></td>
        </tr>
      <tr>
        ...
        <td colspan="2" bgcolor="#FFFFFF"><span style=" padding-left: 10px;font-size: 14px;"><?php echo $fetch_result["religious"]; ?></span></td>
        </tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#99CCCC" >
    ...
    <table>
        ...
        <td colspan="2" bgcolor="#FFFFFF"><span style="padding-left: 10px; font-size: 14px;">
          ...
          <a href="img/<?php print $_GET['id']?>tc.jpg" target="_blank" class="print">View</a>

          <?php
                $pathdocument=$_GET['id']."tc.jpg";
                if (file_exists('img/'.$pathdocument)) 
                {
	...
	<td>
		...
		<tr>
				<td  align="center">
					...
					I am willing to be admitted in accordance with all the rules and regulations of the organization.<br> (আমি প্রতিষ্ঠানের যাবতীয় নিয়ম-শৃঙ্খলা মেনে ভর্তি হতে ইচ্ছুক।)
    ...
    <table>
      ...
      <tr>
        ...
        <td colspan="2" bgcolor="#FFFFFF"><span style="padding-left: 10px; font-size: 14px;">............................</span></td>
          ...
          <tr>
        <td   bgcolor="#FFFFFF"><span style="padding-left: 10px; font-size: 14px;"> Stay in Hostel?  </span></td>
        <td bgcolor="#FFFFFF"><span style="padding-left: 10px; font-size: 14px;">:</span></td>
        <td colspan="2" bgcolor="#FFFFFF"><span style="padding-left: 10px; font-size: 14px;">............................</span></td>
        </tr>
...
<tr id="print">
 ...
 <td id="print">
                ...
                <center> <input type="button" onClick="window.print()" value="Print" class="btn btn-large btn-danger"  />&nbsp;&nbsp;&nbsp;</center>
