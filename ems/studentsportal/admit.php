...
require "../admin/barcode/vendor/autoload.php";
	...
	$student_select="SELECT * FROM running_student_info  WHERE `student_id`='".$_SESSION["useridid"]."'";
...
WHERE `running_student_info`.`student_id`='".$_SESSION["useridid"]."'";
	...
	$result =  $db->select_query($sql);
		...
		$selectExamName = "SELECT `exam_type` FROM `exam_type_info` WHERE `exam_id`='352007070006'";
...
<style>
	@media print{
			...
			body
			{
				...
				margin-top: 15px;/* margin you want for the content */
			}
		}
</style>
<body>
<center>
		...
		<tr>	
			...
			<table width="100%">
				<tr>
					<td width="24%" align="left"><h5> Student ID: <?php echo $fetch_result["student_id"]?></h5></td>
					<td align="center">
					<h5 style=" text-align: center;"><?php echo $fetchColass["exam_type"];?> - <?php echo date('Y');?></h5></td>
