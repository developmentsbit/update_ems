    ...
    <link rel="stylesheet" href="datespicker/bootstrap.min.css">
	 ...
	 <script>
	 	  $(document).ready(function () {
			...
			function showData(){
				var showStdAttendance="showStdAttendance";
						$.ajax({
									url:"../admin/ajaxDateWiseReport.php",
									type:"POST",
									data:$(".addATeent").serialize() + "&showStdAttendance=" + showStdAttendance,
...
function check_period()
{
        ...
        $.post("../admin/cheking_period.php", { className: class_name,periodshow: periodshow},
	  ...
	  <table width="1075" id="notprint" class="table table-bordered table-responsive" style="margin-top:10px; margin-bottom:0px">
						  <tr>
						   ...
						   <tr>
						  		<td>Select Class</td>
								<td>
									<select class="selectClass" id="selectClass" name="selectClass" onchange="return check_period()"  style="width:250px; height:30px; padding-left:5px;">
								...
								<td>Select Period</td>
								<td colspan="3"><select class="Period" id="Period" name="Period" style="width:250px; padding-left:5px; height:30px;" >
						  	...
						  	<td>Student ID</td>
								<td>
									<input type="text" name="stdID" id="stdID"  value="<?php print $userID;?>"  style="width:250px; padding-left:5px; height:30px;" readonly />

								</td>  

						  	<td>From Date</td>
								<td><input type="text" name="example1" id="example1"  autocomplete="off" autocomplete="off" style="width:250px; padding-left:5px; height:30px;"/></td>  
						  

						  	  	<td>To Date</td>
								<td><input type="text" name="example2" id="example2"  autocomplete="off" autocomplete="off" style="width:250px; padding-left:5px; height:30px;"/></td>  	
