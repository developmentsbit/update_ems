...
<div class="container mt-2">
	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				<h3>@lang('add_noc.addtitle')</h3><br>
				<form method="post" class="btn-submit" action="{{ route('add_noc.store') }}" enctype="multipart/form-data">
					@csrf
					<div class="row myinput">
						...
						<div class="form-group mb-3 col-md-6">
							<label>@lang('add_noc.title_en'): <span class="text-danger" style="font-size: 15px;">*</span></label>
							<div class="input-group mt-2">
						...
						<div class="form-group mb-3 col-md-6">
							<label>@lang('add_noc.details_en'): </label>
							<div class="input-group mt-2">
