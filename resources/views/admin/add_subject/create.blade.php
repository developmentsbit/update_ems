		...
		<div class="card">
			<div class="card-body">
                <div class="main_from mt-2">
                    <h6 class="bg-dark text-light border-bottom border-3 border-info rounded-bottom fs-5 p-2">@lang('add_subject.addtitle')</h6>
                </div>
				<form method="post" class="btn-submit" action="{{ route('add_subject.store') }}" enctype="multipart/form-data">
					...
					<div class="row myinput">
						...
						<div class="form-group mb-3 col-md-6">
							...
							<div class="input-group mt-2">
								<input class="form-control" type="text" name="subject_name_en" id="subject_name_en" required="">
							</div>
						</div>
						<div class="form-group mb-3 col-md-6">
							<label>@lang('add_subject.subject_name_bn'): </label>
							<div class="input-group mt-2">
								<input class="form-control" type="text" name="subject_name_bn" id="subject_name_bn">
							</div>
						</div>
						<div class="form-group mb-3 col-md-6">
						...
						<div class="form-group mb-3 col-md-6">
							...
							<div class="input-group mt-2">
								<select class="form-control" name="status">
									<option value="1">@lang('add_subject.compulsory_subject')</option>
									<option value="2">@lang('add_subject.group_subject')</option>
									<option value="2">@lang('add_subject.optional_subject')</option>
								</select>
							</div>
						</div>
						<div class="form-group mb-3 col-md-6">
