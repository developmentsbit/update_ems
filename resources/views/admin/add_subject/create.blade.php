				...
				<form method="post" class="btn-submit" action="{{ route('add_subject.store') }}" enctype="multipart/form-data">
					...
					<div class="row myinput">
						...
						<div class="form-group mb-3 col-md-4">
							...
							<div class="input-group mt-2">
								<input class="form-control form-control-sm" type="text" name="subject_name_en" id="subject_name_en" required="">
							</div>
						</div>
						<div class="form-group mb-3 col-md-4">
						...
						<div class="form-group mb-3 col-md-4">
							...
							<div class="input-group mt-2">
								<select class="form-control form-control-sm" name="subject_type">
									...
									<option value="3">@lang('add_subject.optional_subject')</option>
								</select>
							</div>
						</div>
						<div class="form-group mb-3 col-md-4">
