...
<div class="container mt-2">
	...
	<div class="col-12">
		...
		<div class="card">
			<div class="card-body">
				<h3>@lang('supplier_info.cash_receiver_info')</h3><br>
				<form method="post" class="btn-submit" action="{{ route('cash_receiver_info.update',$data->id) }}" enctype="multipart/form-data">
					@csrf
                    @method('PUT')
