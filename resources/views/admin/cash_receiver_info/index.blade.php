...
@section('content')
    <div class="container">
        ...
        @component('components.breadcrumb')
            @slot('title')
            @lang('supplier_info.cash_receiver_info')
            @endslot
            @slot('breadcrumb1')
            ...
            @if (\App\Traits\RolePermissionTrait::checkRoleHasPermission('user', 'create'))
                ...
                @slot('action_button1_link')
                    {{ route('cash_receiver_info.create') }}
                @endslot
            @endif
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="header-title">  @lang('supplier_info.cash_receiver_info')</h4>
                        ...
                        <div class="tab-content">
                                ...
                                <table id="datatable-users-all" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($lang == 'en')
                                                {!! $v->address ?: $v->address_bn !!}
                                                @elseif($lang == 'bn')
                                                {!! $v->address_bn ?: $v->address !!}
                                                @endif
                                            </td>
                                            <td>
                                                <a style="float: left;" class="btn btn-sm btn-info" href="{{route('cash_receiver_info.edit',$v->id)}}"><i class="fa fa-edit"></i></a>
                                                <form method="post" action="{{route('cash_receiver_info.destroy',$v->id)}}">
                                                    @csrf
                                                    @method('DELETE')
                            ...
                            $deleted = cash_receiver_info::onlyTrashed()->get();
                            $i = 1;
                            @endphp
                                ...
                                <table id="datatable-users-deleted" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('retrive_cash_receiver_info') }}/{{ $v->id }}" class="btn btn-sm btn-warning">@lang('common.restore')</a>

                                                <a href="{{ url('delete_cash_receiver_info') }}/{{ $v->id }}" class="btn btn-danger btn-sm">@lang('common.deleted_permanently')</a>
                                            </td>
                                        </tr>
