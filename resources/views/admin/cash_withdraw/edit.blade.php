...
<div class="container mt-2">
	...
	<div class="col-12">
		...
		<div class="card">
			<div class="card-body">
				<h3>@lang('supplier_info.cash_withdraw')</h3><br>
				<form method="post" class="btn-submit" action="{{ route('cash_withdraw.update',$data->id) }}" enctype="multipart/form-data">
					@csrf
                    @method('PUT')
					<div class="row myinput">
						...
						<div class="form-group mb-3 col-md-4">
							...
							<div class="input-group mt-2">
								<input class="form-control form-control" type="text" name="withdraw" id="withdraw"  required="" value="{{ $data->withdraw }}">
							</div>
						</div>
