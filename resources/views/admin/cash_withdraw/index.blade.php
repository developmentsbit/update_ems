            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="header-title">  @lang('supplier_info.cash_withdraw')</h4>
                                ...
                                <table id="datatable-users-all" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a style="float: left;" class="btn btn-sm btn-info" href="{{route('cash_withdraw.edit',$v->id)}}"><i class="fa fa-edit"></i></a>
                                                <form method="post" action="{{route('cash_withdraw.destroy',$v->id)}}">
                                                    @csrf
                                                    @method('DELETE')
                                ...
                                <table id="datatable-users-deleted" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('retrive_cash_withdraw') }}/{{ $v->id }}" class="btn btn-sm btn-warning">@lang('common.restore')</a>

                                                <a href="{{ url('delete_cash_withdraw') }}/{{ $v->id }}" class="btn btn-danger btn-sm">@lang('common.deleted_permanently')</a>
                                            </td>
                                        </tr>
