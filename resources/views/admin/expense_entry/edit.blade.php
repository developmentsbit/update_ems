...
<div class="container mt-2">
	...
	<div class="col-12">
		...
		<div class="card">
			<div class="card-body">
				<h3>@lang('expense_entry.edittitle')</h3><br>
				<form method="post" class="btn-submit"  action="{{ route('expense_entry.update',$data->id) }}" enctype="multipart/form-data">
					@csrf
                    @method('PUT')
                        ...
                        <div class="form-group mb-3 col-md-6">
							...
							<div class="input-group mt-2">
                                <select class="form-control" name="expense_id">
									...
									<option value="{{ $i->id }}" <?php if ($i->id == $data->expense_id) {
										echo "selected";
