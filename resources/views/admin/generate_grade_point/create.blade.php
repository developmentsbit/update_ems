		...
		@component('components.breadcrumb')
            ...
            @if (\App\Traits\RolePermissionTrait::checkRoleHasPermission('role', 'create'))
                ...
                @slot('action_button1_link')
                    {{ route('generate_grade_point.index') }}
                @endslot
            @endif
            ...
            <div class="container">
                <div class="main_from mt-1 ">
                    <div class="main_from mt-2">
                        <h5 class="bg-dark text-light border-bottom border-3 border-info rounded-bottom fs-5 p-2 ">Generate Grade Point Avg. (GPA) :</h5>
                      </div>
                    ...
                    <form class="">
                            <div class="row mx-5">
                                ...
                                <div class="col-md-8 mt-2">
                                    <div class="row ">
                                        <label for="inputPassword3" class="col-sm-4 col-form-label  text-md-end text-dark">
                                            @lang('add_marks.select_session')  :</label>
                                        <div class="col-sm-7">
                                            <select class="form-select" id="session" name="session">
                                                <option selected>
                                                  Select One</option>
                                ...
                                <div class="col-md-8 mt-3 limit ">
                                    <button class="btn btn-danger">Result Generate</button>
                                    <button class="btn btn-danger">Update Result</button>
                                    <button class="btn btn-danger">Show Total Student</button>
                                </div>
