...
<div class="container mt-2">
		@component('components.breadcrumb')
            @slot('title')
                @lang('institute_position_details.edittitle')
            @endslot
            @slot('breadcrumb1')
	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				<h3>@lang('institute_position_details.edittitle')</h3><br>
				<form method="post" class="btn-submit" action="{{ route('institute_position_details.update',$data->id) }}" enctype="multipart/form-data">
					@csrf
					@method('PUT')
					<div class="row myinput">
						...
						<div class="form-group mb-3 col-md-6">
							<label>@lang('institute_position_details.title_en'): </label>
							<div class="input-group mt-2">
						...
						<div class="form-group mb-3 col-md-6">
							<label>@lang('institute_position_details.details_en'): <span class="text-danger" style="font-size: 15px;">*</span></label>
							<div class="input-group mt-2">
