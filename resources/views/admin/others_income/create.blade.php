...
<div class="container mt-2">
	...
	<div class="col-12">
		...
		<div class="card">
			<div class="card-body">
				<h3>@lang('others_income.title')</h3><br>
				<form method="post" class="btn-submit" action="{{ route('others_income.store') }}" enctype="multipart/form-data">
					@csrf
