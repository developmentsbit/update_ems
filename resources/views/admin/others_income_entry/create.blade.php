...
<div class="container mt-2">
		@component('components.breadcrumb')
            @slot('title')
                @lang('others_income_entry.managetitle')
            @endslot
            @slot('breadcrumb1')
	...
	<div class="col-12">
		...
		<div class="card">
			<div class="card-body">
				<h3>@lang('others_income_entry.addtitle')</h3><br>
				<form method="post" class="btn-submit" action="{{ route('others_income_entry.store') }}" enctype="multipart/form-data">
					@csrf
