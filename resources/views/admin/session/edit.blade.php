	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
                <div class="container">
                    <div class="form">
                        <form method="post" class="row g-3 mt-0 btn-submit" action="{{ route('session.update',$data->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row myinput">
                                <div class="form-group mb-3 col-md-6">
                                    ...
                                    <div class="input-group mt-2">
                                        <input class="form-control form-control-sm" type="text" name="session" id="session"  value="{{ $data->session }}" required="">
                                    </div>
                                </div>
                                <div class="form-group mb-3 col-md-6">
