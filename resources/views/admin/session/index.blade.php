	...
	<div class="col-12">
		...
		<div class="card">
			<div class="card-body">
				...
				<h3>@lang('session.managetitle')</h3><br>
                        ...
                        <table class="table table-striped dt-responsive nowrap w-100" id="alternative-page-datatable" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{route('session.edit',$d->id)}}" class="btn btn-info border-0 edit text-light">@lang('common.edit')</a>
                                            <form action="{{route('session.destroy',$d->id)}}" method="POST">
                                                @csrf
                                                @method('DELETE')
