	...
	<div class="col-12">
		...
		<div class="card">
			<div class="card-body">
				...
				<form method="post" class="btn-submit mt-3" action="{{ route('student_attendance_info.update',$data->id) }}" enctype="multipart/form-data">
					@csrf
					@method('PUT')
					...
					<div class="row myinput">
						...
						{{-- <div class="form-group mb-3 col-md-6">
                            ...
                            <a href="{{asset('admin/student_attendance_info')}}/{{$data->image}}" download="" class="btn btn-success btn-sm">@lang('common.download')</a>
