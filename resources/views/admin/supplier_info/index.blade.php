            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="header-title">  @lang('supplier_info.title')</h4>
                        ...
                        <div class="tab-content">
                                ...
                                <table id="datatable-users-all" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a style="float: left;" class="btn btn-sm btn-info" href="{{route('supplier_info.edit',$v->id)}}"><i class="fa fa-edit"></i></a>
                                                <form method="post" action="{{route('supplier_info.destroy',$v->id)}}">
                                                    @csrf
                                                    @method('DELETE')
                            ...
                            $deleted = supplier_info::onlyTrashed()->get();
                            $i = 1;
                            @endphp
                                ...
                                <table id="datatable-users-deleted" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('retrive_supplier_info') }}/{{ $v->id }}" class="btn btn-sm btn-warning">@lang('common.restore')</a>

                                                <a href="{{ url('delete_supplier_info') }}/{{ $v->id }}" class="btn btn-danger btn-sm">@lang('common.deleted_permanently')</a>
                                            </td>
                                        </tr>
