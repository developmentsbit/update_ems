	...
	<div class="col-12">
		...
		<div class="card">
			<div class="card-body">
				...
				<form method="post" class="btn-submit" action="{{ route('supplier_payment.update',$data->id) }}" enctype="multipart/form-data">
					@csrf
                    @method('PUT')
					<div class="row myinput">
                        ...
                        <div class="form-group mb-3 col-md-6">
							...
							<div class="input-group mt-2">
								<input class="form-control form-control" type="text" name="receiver" id="receiver"  required="" value="{{ $data->receiver }}">
							</div>
						</div>
                        <div class="form-group mb-3 col-md-6">
