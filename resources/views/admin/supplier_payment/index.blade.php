            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="header-title">  @lang('supplier_info.supplier_payment')</h4>
                                ...
                                <table id="datatable-users-all" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a style="float: left;" class="btn btn-sm btn-info" href="{{route('supplier_payment.edit',$v->id)}}"><i class="fa fa-edit"></i></a>
                                                <form method="post" action="{{route('supplier_payment.destroy',$v->id)}}">
                                                    @csrf
                                                    @method('DELETE')
                                ...
                                <table id="datatable-users-deleted" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('retrive_supplier_payment') }}/{{ $v->id }}" class="btn btn-sm btn-warning">@lang('common.restore')</a>
