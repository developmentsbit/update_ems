		...
		@component('components.breadcrumb')
            ...
            @if (\App\Traits\RolePermissionTrait::checkRoleHasPermission('role', 'create'))
                ...
                @slot('action_button1_link')
                    {{ route('view_total_subject_marks.index') }}
                @endslot
            @endif
            ...
            <div class="container">
                <div class="main_from mt-1 ">
                    <div class="main_from mt-2">
                        <h5 class="bg-primary   text-light border-bottom border-3 border-dark rounded-bottom fs-5 p-2">@lang('result_entry.total_mark') :</h5>
                      </div>
