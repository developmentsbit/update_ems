...
function check_availability()
{
    ...
    var Checksubject="Checksubject";
        ...
        $.post("admin/check_online_exam_sub.php", { className: class_name,Checksubject:Checksubject},
            function(result){
                //if the result is 1
                if(result !=0 )
                {
...
function checkExamType()
{
    ...
    var subjectName = $('#subjectName').val();
        ...
        $.post("admin/check_online_exam_sub.php", { className: className,subjectName:subjectName,checkExam:checkExam},
            function(result){
                //if the result is 1
                if(result !=0 )
                {
...
function resultShow()
{
 ...
 var subjectName = $('#subjectName').val();
     ...
     var checking_html = '<img src="img/loading.gif" /> Checking...';
      $('#viewQuestionReport').html(checking_html);
            $.ajax({
                url:"OnlineResult.php",
                type:"POST",
                data :{result:result,examType:examType,subjectName:subjectName},
                cache:false,
                success:function(data)
                {
                    $('#viewQuestionReport').html(data);
...
<style type="text/css">
  ...
  <body>
    ...
    <div class="container print" style="margin-top: 30px;">

  <div class="panel panel-default" style="border-radius: 0px;">
  <div class="panel-heading" style="font-size: 16px; color: #16a085; text-transform: uppercase;"><b>Online Exam Result</b></div>
...
<form>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-12 ">
          ...
          <label><input type="button" name="button" value="Show Result" class="btn btn-primary" style="border-radius:0px;" onclick="resultShow()" ></label>
