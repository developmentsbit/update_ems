        ...
        <tr>    
                ...
                <td>
                        ...
                        <div style="float: left; clear: right; text-align: center; width: 70% ">   
                                ...
                                <li style="color:#000000; font-family:microsoft-sun-serif;  font-size:30px; list-style: none;">Feni Govt. College</li>

                               <li style="list-style: none; ">

                                    <p style="font-size:16px;font-family:Arial, Helvetica, sans-serif">College Road, Feni
                                </p>

                                </li>

                                <li style=" list-style: none; font-size:14px;font-family:Arial, Helvetica, sans-serif">www.fgc.gov.bd<br>  </li>
                             </ul> 
...
WHERE `examsetup`.`id`='".$_POST["examType"]."'";
             ...
             ?></td>
                            ...
                            <tr>
                                    ...
                                    <td style="border-right: 1px #000 solid; border-top: 1px #000 solid; border-bottom: 1px #000 solid; border-right: 1px #000 solid;"><b>Obtain Marks</b></td>
                                       <!--<td style="border-right: 1px #000 solid; border-top: 1px #000 solid; border-bottom: 1px #000 solid; border-right: 1px #000 solid;" class="print"><b>Answer Paper</b></td>-->
                            </tr>
...
INNER JOIN `running_student_info` ON `running_student_info`.`student_id`=`answer_sheet`.`Student_ID` WHERE  `answer_sheet`.`Exam_ID`='".$_POST["examType"]."'
...
while($fetch=$query->fetch_array())
{
                             ...
                             <tr>
                                    ...
                                    <td style="border-right: 1px #000 solid; border-top: 1px #000 solid; border-bottom: 1px #000 solid; text-transform: uppercase; "><?php print $fetch[2]; ?></td>
                                    <td style="border-right: 1px #000 solid; border-top: 1px #000 solid; border-bottom: 1px #000 solid; border-right: 1px #000 solid;" ><b>
                                        
                                            <?php

                                                $marks="SELECT `Marks` FROM `online_result` WHERE `ID`='$fetch[0]' AND `examID`='".$_POST["examType"]."'";
                                                $count=$db->link->query($marks);
                                                $cfetch=$count->fetch_array();
                                     ...
                                     <!--<td style="border-right: 1px #000 solid; border-top: 1px #000 solid; border-bottom: 1px #000 solid; " target="_blank" class="print">  -->
                                     <!--<a href="exam/AnsPaper.php?examID=<?php print $exam;?>&StdID=<?php print $fetch[0]; ?>" class='btn btn-success'> View </a>-->
