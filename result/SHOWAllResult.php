...
<div class="col-lg-7 col-sm-12 col-lg-offset-2 jumbotron" style="border:3px #FFFFFF solid; background:#FFFFFF" id="AddMarksStep1">
								...
								<table class="table-responsive">
											...
											<tr >
													<td align="right"><br/><span class="text-justify" style="font-size:13px; color:#FFFFFF;"><strong><a href="./" style="font-size:13px; color:#FFFFFF; text-decoration:none" >Official Website of FGC</a></strong>
	</span><br/></td>
											</tr>
											</table>
