<?php
  ...
  require_once("../db_connect/conect.php");
    $db = new database();
      ...
      // $sq="SELECT `answer1`,`answer2`,`answer3`,`answer4`,`id` FROM `questionadd` WHERE `subject`='sub-0001' ORDER BY `id` ASC  LIMIT 20,10";
      ...
      //         $u="UPDATE `answer_sheet` SET `Answer`='True' WHERE `Qiestion_ID`='$f[4]' AND `Option`='$ans'"."<br>";
      //         print $u;
      //        $uq=$db->link->query($u);
      //     }
      // }
