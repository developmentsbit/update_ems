<?php
  ...
  $select="SELECT * FROM `collegemosqueinfo`";
   ...
   if($checked_query)
    ...
    if(isset($_POST['add']))
    {
      ...
      $about_school=$db->escape($_POST['Contact_Textarea']);
    	...
    	{
    	$insert="INSERT INTO `collegemosqueinfo` VALUES('1','$title','$about_school')";
  ...
  if(isset($_POST['Update']))
    {
      ...
      {
      	$insert="REPLACE INTO `collegemosqueinfo` VALUES('1','$title','$about_school')";
...
if(isset($_POST['Delete'])){
	$Delete="DELETE FROM `collegemosqueinfo` WHERE `id`='1'";
...
<body>
  ...
  <div class="panel-heading" style="font-size: 16px; color: #16a085; text-transform: uppercase;"><b>College Mosque  Information</b></div>
