  ...
  if(isset($_POST["transfer"]))
        {
                $select="SELECT * FROM `questionadd` WHERE `class`='311609230006' AND `subject`='sub-0058'";
                $selectQuestion=$db->link->query($select);
                if($selectQuestion)
                {
                    while($fetchData=$selectQuestion->fetch_array())
                    {
                    	$makeid=$db->withoutPrefix('questionadd','id','Q-','8');
	
                    	$q="INSERT INTO `questionadd` (`id`,`class`,`subject`,`question`,`option1`,`option2`,`option3`,`option4`,`answer1`,`answer2`,`answer3`,`answer4`,`chapter_name`,`question_type`) VALUES('$makeid','311609230007','sub-0078','$fetchData[3]','$fetchData[4]','$fetchData[5]','$fetchData[6]','$fetchData[7]','$fetchData[8]','$fetchData[9]','$fetchData[10]','$fetchData[11]','$fetchData[12]','$fetchData[13]')";
...
function confirmDelete()
{
  ...
  <div class="panel-heading" style="font-size: 16px; color: #16a085; text-transform: uppercase;"><label> <b> Add Question </b></label>    </div>
...
<div class="form-row">
    <div class="form-group col-md-12">
      ...
      <textarea class="form-control " id="Question"  name="Question"><?php if($selectQuestion){print $fetchData[3];}?></textarea>
  ...
  <div class="form-row">
    <div class="form-group col-md-8 ">
      <label>Option A</label>
           ...
           <input type="text"  class="form-control " id="Option1"  name="Option1" value="<?php 
                if($selectQuestion)
                {
                    print $fetchData[4];
                }?>"></input>
 ...
 <input type="text"  class="form-control " id="Option2"  name="Option2"  value="<?php 
                if($selectQuestion)
                {
                    print $fetchData[5];
                }?>"></input>
  ...
  <div class="form-row">
    <div class="form-group col-md-8 ">
         <label>Option C</label>
           ...
           <input type="text"  class="form-control " id="Option3"  name="Option3" value="<?php 
                if($selectQuestion)
                {
                    print $fetchData[6];
                }?>"></input>
  ...
  <div class="form-row">
    <div class="form-group col-md-8 ">
       <label>Option D</label>
           ...
           <input type="text"  class="form-control " id="Option4"  name="Option4" value="<?php 
                if($selectQuestion)
                {
                    print $fetchData[7];
                }?>"></input>
...
<div class="container-fluid"> 
  ...
  <div class="form-row">
    <div class="form-group col-md-12 ">
        ...
        <label ><input type="button" name="button" value="Add Question" class="btn btn-success" id="addbtn" style="border-radius:0px;"  onclick="return AddQuestion()"></label>
 ...
 <!--         <label ><input type="button" name="button" value="Edit Question" class="btn btn-info" style="border-radius:0px;"  onclick="return EditQuestion('<?php echo $fetchData[0];?>')"></label> -->
         ...
         <label ><input type="submit" name="button" value="   Clear  " class="btn btn-danger" style="border-radius:0px;"  onclick="return Clear()"></label>

         <label ><input type="submit" name="transfer" value="   transfer  " class="btn btn-danger" ></label>
