<?php
  ...
  { 
    ...
    $sql="SELECT other_cost.`id`,`other_cost`.`date`,`income_expense_title`.`title`,`other_cost`.`description`,`other_cost`.`amount`,`other_cost`.`Entry_Date` FROM other_cost INNER JOIN `income_expense_title`
...
<html lang="en">
 ...
 <p style="margin-top:-1px;font-size:16px;font-family:Arial, Helvetica, sans-serif">Shahid Shahidullah Kaiser Shorok, Feni.   </p>
   ...
   <tr>
                    <td width="20" align="center" colspan="5"><h2>Expense Report</h2></td>
