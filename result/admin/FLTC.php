<?php
  ...
  $select="SELECT * FROM `fltc2information`";
   ...
   if($checked_query)
    ...
    if(isset($_POST['add']))
    {
      ...
      $about_school=$db->escape($_POST['Contact_Textarea']);
    	...
    	{
    	$insert="INSERT INTO `fltc2information` VALUES('1','$title','$about_school')";
  ...
  if(isset($_POST['Update']))
    {
      ...
      {
      	$insert="REPLACE INTO `fltc2information` VALUES('1','$title','$about_school')";
...
if(isset($_POST['Delete'])){
	$Delete="DELETE FROM `fltc2information` WHERE `id`='1'";
	$db->delete_query($Delete);
  print "<script>location='FLTC.php'</script>";
...
<body>
  ...
  <div class="panel-heading" style="font-size: 16px; color: #16a085; text-transform: uppercase;"><b>FLTC-2 Information</b></div>
