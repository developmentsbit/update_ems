...
<link rel="stylesheet" href="../css/loading/loading.css" />
  ...
  <div class="panel-heading" style="font-size: 16px; color: #16a085; text-transform: uppercase;"><b>MP Message</b></div>
  <div class="panel-body">
   ...
   <div class="col-md-9 col-md-offset-1" id="AddMarksStep1" style="margin-top: 20px;">
    ...
    <label>Name  :</label>
     <input type="text" name="name" <?php if($chek_all){?> value="<?php echo $fetch_all[1];?>" <?php } else {?> value="" <?php }?> class="form-control" placeholder="Name"  style="height: 40px; border-radius: 0px;"/>
      ...
      <div class="form-group">
    <label >Title  :</label>
    <input type="text" name="title" <?php if($chek_all){?> value="<?php echo $fetch_all[2];?>" <?php } else {?> value="" <?php }?> class="form-control" placeholder="Title" style="height: 40px; border-radius: 0px;" />
    ...
    <label >Picture  :</label>
          ...
          <?php
           ...
           ?>
           <img src="../other_img/founder.jpg" class="img-responsive img-thumbnail" height="120" width="100">
           <?php }?>
