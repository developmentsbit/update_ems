...
error_reporting(1);
   ...
   $fetch_zero[2]='';
   $fetch_zero[1]='';
   	$select="SELECT * FROM `inflow_structure`";
    ...
    if(isset($_POST['add']))
    {
      ...
      $about_school=$db->escape($_POST['Contact_Textarea']);
    	...
    	{
    	$insert="INSERT INTO `inflow_structure` VALUES('1','$title','$about_school')";
  ...
  if(isset($_POST['Update']))
    {
      ...
      {
        $insert="REPLACE INTO `inflow_structure` VALUES('1','$title','$about_school')";
...
if(isset($_POST['Delete'])){
	$Delete="DELETE FROM `inflow_structure` WHERE `id`='1'";
	$db->delete_query($Delete);
	print "<script>location='Inflow_structure.php'</script>";
...
<body>
 ...
 <div class="col-sm-12 col-xs-12" style="margin-top: 30px;">
  ...
  <div class="panel-heading" style="font-size: 16px; color: #16a085; text-transform: uppercase;"><b>Inflow Structure</b></div>
