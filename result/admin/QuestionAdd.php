...
function confirmDelete()
{
  ...
  <div class="panel-heading" style="font-size: 16px; color: #16a085; text-transform: uppercase;"><label> <b> Add Question </b></label><label style="float: right;"> <a href="MathFormula.php" target="_blank"> Mathematical Equations </a> </label>    </div>
