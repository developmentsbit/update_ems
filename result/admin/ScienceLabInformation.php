<?php
  ...
  $select="SELECT * FROM `sciencelabinfo`";
   ...
   if($checked_query)
    ...
    if(isset($_POST['add']))
    {
      ...
      $about_school=$db->escape($_POST['Contact_Textarea']);
    	...
    	{
    	$insert="INSERT INTO `sciencelabinfo` VALUES('1','$title','$about_school')";
  ...
  if(isset($_POST['Update']))
    {
      ...
      {
      	$insert="REPLACE INTO `sciencelabinfo` VALUES('1','$title','$about_school')";
...
if(isset($_POST['Delete'])){
	$Delete="DELETE FROM `sciencelabinfo` WHERE `id`='1'";
	$db->delete_query($Delete);
  print "<script>location='ScienceLabInformation.php'</script>";
...
<body>
  ...
  <div class="panel-heading" style="font-size: 16px; color: #16a085; text-transform: uppercase;"><b>Science Lab Information</b></div>
