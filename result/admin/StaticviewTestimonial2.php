	...
	$sqlForTest="SELECT `static_testomonial`.*,`distributedtestomoniallist`.* FROM `static_testomonial` INNER JOIN `distributedtestomoniallist` ON `distributedtestomoniallist`.`studentId`=`static_testomonial`.`boardResultID` WHERE `static_testomonial`.`boardResultID`='".$_GET["stdid"]."'";
...
<body>
	<?php if($fetchForall[1]=='Honours') { ?>
<div style="height:755px; width:1000px; background-image:url(all_image/Honours.jpg);background-repeat: no-repeat; margin:15px;">
  ...
  <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td><table width="99%" height="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td align="center" height="22"><span style="color:#990000; font-family:Arial, Helvetica, sans-serif; font-size:28px; font-weight:bold; letter-spacing:1px;">
    ...
    <tr>
      ...
      <td valign="top">
        ...
        <tr>
          ...
          <span style="font-family:sans-serif, fantasy, monospace; padding-left:5px; font-size:18px; letter-spacing:1px; word-spacing:5px;"><i> was a student of<strong> Honours Course</strong>  of this College.  <?php
				if( $fetchForall["gender"] == "Male")
				{
					echo "He";
				}
        ...
        <tr>
          <td><span style="font-family:sans-serif, fantasy, monospace; padding-left:5px; font-size:18px; letter-spacing:1px; word-spacing:10px;"><i>
          	<i> 
          	 examination from National University in <strong><?php
					if(isset($fetchForall)){
			...
			?> </strong>bearing Roll No.<strong> <?php  
					if(isset($fetchForall)){
        ...
        <tr>
          <td><span style="font-family:sans-serif, fantasy, monospace; padding-left:5px; font-size:18px; letter-spacing:1px; word-spacing:6px;"><i>Registration No. <strong> <?php
					if(isset($fetchForall)){
...
from  <strong><?php
        ...
        <tr>
          <td><span style="font-family:sans-serif, fantasy, monospace; padding-left:5px; font-size:18px; letter-spacing:1px; word-spacing:7px;"><i>   GPA <strong><?php
					if(isset($fetchForall)){
			...
			?> </strong>in the scale of GPA-4.00.</i></span></td>
        </tr>
        <tr>
          <td height="3">&nbsp;</td>
        </tr>
    ...
    <tr>
      ...
      <td valign="top">
        ...
        <tr>
          ...
          <span style="font-family:sans-serif, fantasy, monospace; padding-left:5px; font-size:18px; letter-spacing:1px; word-spacing:3px;"><i> was a student of<strong> Degree pass course</strong>  of this College.  <?php
				if( $fetchForall["gender"] == "Male")
				{
					echo "He";
				}
        ...
        <tr>
          <td><span style="font-family:sans-serif, fantasy, monospace; padding-left:5px; font-size:18px; letter-spacing:1px; word-spacing:10px;"><i>
          	<i> 
          	 course examination from National University in <strong><?php
					if(isset($fetchForall)){
						echo $fetchForall["year"];
					}
					else {
        ...
        <tr>
          <td><span style="font-family:sans-serif, fantasy, monospace; padding-left:5px; font-size:18px; letter-spacing:1px; word-spacing:6px;"> <i> and Registration No. <strong> <?php
					if(isset($fetchForall)){
						echo $fetchForall["RegNo"];
					}
					else {
...
from  <strong><?php
        ...
        <tr>
          <td><span style="font-family:sans-serif, fantasy, monospace; padding-left:5px; font-size:18px; letter-spacing:1px; word-spacing:7px;"><i>   GPA/Division <strong><?php
					if(isset($fetchForall)){
						echo $fetchForall["GPA"];
					}
					else {
