...
<?php
    ...
    <title>Student's Rigister Book</title>
...
function showIdby(){
 ...
 Student's  Rigister Book   </span> </td>
            </tr>
...
<style type="text/css">
    ...
    a[href]:after {
        content: none !important;
				...
				<a target="_blank" class="print" href='student_print_vaocher.php?id="<?php print $_POST['stdId'] ?>"&Lid="dddd"&year="<?php print $_POST['year'] ?>"&date="<?php print $fetchvou[2];?>"&clas="<?php print $fetchvou[1];?>andNull"&last_id="<?php print $fetchvou[0];?>"'>
