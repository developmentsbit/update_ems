<?php
    ...
    if(isset($_POST['add']))
    {
          if(!empty($_POST['teaherid']) && !empty($_POST['custom_indexno']) && !empty($_POST['teachername']) && !empty($_POST["type"]) && !empty($_POST['email']))
        {
				  ...
				  <tr class="info">
                    ...
                    <td colspan="2">
                        <div class="col-lg-12 col-md-8 col-sm-8 has-warning ">
                         ...
                         <input type="radio" name="type" placeholder="Your Name" class="radio-inline" value="Stuff" style="margin-left:35px;"/>Staff 
                           <?php } ?>
