...
function check_availability()
{
  ...
  <body>
  	<form name="teacherinfo" action="viewTranactionReport.php" method="get"  enctype="multipart/form-data" class="form-horizontal marksEditEntry" >
