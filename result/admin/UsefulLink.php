...
<body>
  ...
  <div class="panel-heading" style="font-size: 16px; color: #16a085; text-transform: uppercase;"><b>Usefull links</b></div>
  <div class="panel-body">
   <form action="" method="post">
    ...
    <label >ID  :</label>
  <input type="text" name="link_id" value="<?php echo $fetch[0]; ?>"  class="form-control" style="border-radius: 0px; height: 40px;" />
  </div>  
    ...
    <div class="form-group">
    <label >Title  :</label>
 <input type="text" <?php if(isset($fetch)) { ?> value="<?php echo $fetch[1];  ?>" <?php  } ?> name="link_title" class="form-control" placeholder="Link title" style="border-radius: 0px; height: 40px;" />
  </div>  
    ...
    <div class="form-group">
    <label >URL  :</label>
  <input type="text" name="link_url" <?php if(isset($fetch)) { ?> value="<?php echo $fetch[2];  ?>" <?php  } ?> class="form-control" placeholder="Url" style="border-radius: 0px; height: 40px;" />
  </div>  
