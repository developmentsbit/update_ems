...
<?php
		  $sql="SELECT `teachers_name`,`designation`,`mobile_no`,`present_address`,`gender`,`email`,`teachers_id` FROM `teachers_information` WHERE `Type`='Teacher' order by `custom_index` ASC";
