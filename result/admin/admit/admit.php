		...
		<tr>	
				...
				<td>
						...
						<div style="float: left; clear: right; text-align: center; width: 70% ">   
							    ...
							    <li style="color:#000000; font-family:microsoft-sun-serif;  font-size:30px; list-style: none;"> <h2  style="font-size:40px; color:GREEN"> <?php print $fetch_school_information['institute_name'] ?></h2></li>
