				...
				<table width="62%" class="table table-responsive table-hover table-bordered">
							<tr>
								<td align="right" colspan="10">
									...
									<input type="button" onclick="return creatAdmin()" class="btn btn-success btn-sm" style="width:120px;" value="Create Testimonial" />
										<input type="button" class="btn btn-danger btn-sm" style="width:120px;" onclick="return deleteFunction()" value="Delete" />
											<input type="submit" class="btn btn-info btn-sm" style="width:120px;" value="Represh" />								</td>
							</tr>
							<?php 
									...
									<tr>
										...
										<tr align="center">
											...
											<td width="17%">
												...
												<label> <a href="StaticviewTestimonial.php?date=<?php echo date('d/m/Y')?>&stdid=<?php echo $fetchforAll["boardResultID"];?>" class="btn btn-success btn-sm" target="_blank">Show Testimonial</a></label>
...
<?php if(isset($_POST["statNotid"])){
		...
		//rint "dd";
			$bdid=$db->withoutPrefix('statictestomonialinfo','boardResultID','23','8');
