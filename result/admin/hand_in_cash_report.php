                    ...
                    <td colspan="2">
                               <table class="table table-bordered">
                                   <tr>
                                    ...
                                    <tr>
                                        <td>Bank Balance: <?php print $fetch['BankBalanceDetails']?> </td>
                                        <td align="right"><?php print $fetch['TotalBankBalance']?></td>
                                       
                                   </tr>
                                      <tr>
                                        <td align="right">Total : </td>
                                        <td align="right"><?php print $fetch['TotalBankBalance']+$fetch['hend_in_cash']?>.00</td>
