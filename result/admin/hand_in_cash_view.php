   ...
   if(isset($_GET['dlt']))
    {
        ...
        $query="DELETE FROM `hand_in_cash` WHERE `id`='$linid'";
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
               <thead>
                ...
                <tbody>
                <?php
                    $query="SELECT `date`,`previous_balance`,`student_collection`,`bank_withdraw`,`other_collection`,`expences`,`bank_deposit`,`hend_in_cash`,`TotalBankBalance`,`admin`,`CashCloseDuraton` FROM `hand_in_cash`";
