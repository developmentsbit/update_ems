...
if(isset($_POST["view"]))
{
    $query="select * from online_lecture ORDER BY `id` DESC";
        ...
        "<td colspan='13' align='center'>"."<span class='text-success' style='font-size:18px; font-weight:blod;'>Online Lacture </span>"."</td>"."</tr>";
        if($result){
            $table.="";
