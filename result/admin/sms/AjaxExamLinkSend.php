	...
	if($sql)
	{
     		while($fetch = $sql->fetch_array())
     		{
                ...
                $stdNewID= bin2hex(openssl_encrypt($fetch[0],'AES-128-CBC', $key));
     			...
     			$CustomMessage="Feni Govt. College  Sub:$smsTitle ";
				...
				$sms->sendSms($requestType, $msg, $recipient, $messageType);
						...
						$smsSent="INSERT INTO `sms_history` (`Student_id`,`Class`,`Group`,`sms_title`,`Message`) VALUES('".$fetch[0]."','$type','$date','".$recipient."','$msg')";
