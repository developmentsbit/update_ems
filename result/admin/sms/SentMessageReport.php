...
<style type="text/css">
  ...
  <div class="panel-heading" style="font-size: 16px; color: #16a085; text-transform: uppercase;"><b>SMS Sent Report</b></div>
...
<form>
  ...
  <div class="form-group col-md-6">
      <label for="inputPassword4">Date</label>
        ...
        <input type="text" value="<?php print date('yy-m-d');?>" name='selectDate'  id='selectDate' class='form-control'></input>
    </div>
  </div>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-12 ">
          ...
          <label><input type="button" name="button" value="Show Report" class="btn btn-primary" style="border-radius:0px;" onclick="showReport()" ></label>
