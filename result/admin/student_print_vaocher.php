...
<table width="100%">
    ...
    <tr>
        <td colspan="9" align="center">  <span class="style3" style="float: left; clear: right;"> Print Date & Time : <?php print date(" Y-m-d  h:i:sa")?></span>  <span class="style3" style="  font-weight: bold; float: right;"> [Student Copy] </span> </td>
    </tr>
...
<td height="20"><span class="style3">ID</span></td>
      ...
      <td width="117"><span class="style2">Invoice Date</span></td>
...
<table width="100%">
    ...
    <tr>
        <td colspan="9" align="center">  <span class="style3" style="float: left; clear: right;"> Print Date & Time : <?php print date(" Y-m-d  h:i:sa")?></span>  <span class="style3" style="  font-weight: bold; float: right;"> [Office Copy] </span> </td>
    </tr>
...
?>
        <tr>
          ...
          <td align="center" style="border-bottom:1px solid #333333;border-right:1px solid #333333">
          <?php echo $fetcRow["title"]; ?> </td>
          <td align="right"  style="border-bottom:1px solid #333333;border-right:1px solid #333333">
          <?php 
