...
<table width="510" align="center"  class="table table-bordered  table-responsive table-hover" style="margin-top:30px;">
		...
		}?><input type="checkbox" checked="chacked" class="check_elmnt counstudent" name="chek[]" id="chek-<?php echo $fetchForAl["student_id"];?>" value="<?php echo "$fetchForAl[student_id]and$fetchForAl[class_roll]";?>" /></td>
