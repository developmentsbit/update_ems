...
WHERE `marksheet`.`ClassId`='$className[0]' AND `marksheet`.`ExamId`='$examtype[0]' AND `marksheet`.`GroupID`='$groupname[0]'  AND `marksheet`.`SubjectId`='$sub_name' AND `marksheet`.`Session`='$session' AND `exam_type_info`.`exam_id`='$examtype[0]'  AND `subject_information`.`examID`='$examtype[0]'";
