...
class database {
    ...
    public $servername="sbit_ems.test";
	public $username="root";
	public $pass="";
	// public $db_name="fgc23";
	...
	public function newIdmake($table,$fildname,$prefix,$id_length)
	{
		$query="SELECT MAX($fildname) FROM $table WHERE `session2`='2022-2023'";
		$result=$this->select_query($query)->fetch_array();
		$max_id=$result[0];
		//print $max_id."<br/>";
		$prefix_length=strlen($prefix);
