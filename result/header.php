    ...
    <div class="container-fluid" style="background: #A9CCE3; padding: 3px;">
                      <center>  <a href="mujib100/pages/timeline_bn.html" class="btn btn-danger" style="float: center; width:200px;" target="_blank"> সুবর্ণ জয়ন্তী ও  বঙ্গবন্ধু কর্ণার  </a></center>
                         
  <!--<a href="StudentPortal/login.php" class="btn btn-danger" style="float: right; " target="_blank">Student Login </a> &nbsp;-->
  <!--<a href="OnlineExamResult.php" class="btn btn-success" style="float: right; " target="_blank">Online Exam. Result </a> -->
...
<body>
            ...
            <div class="container-fluid" style="padding: 0px; background:#09c; ">
                ...
                <!-- Brand and toggle get grouped for better mobile display -->
                    ...
                    <li class="dropdown"><a data-toggle="dropdown" class="dropdown-toggle">Administration  &nbsp;<span class="caret" ></span></a>


                      <ul class="dropdown-menu">
                         <li> <a href="?page=PrincipleInfo" style="padding: 10px 15px;"> Principal</a> </li> 
                         <li><a href="?page=VpInfo" style="padding: 10px 15px;"> Vice-Principal</a> </li> 
				...
				?>	
				 ...
				 <li><a href="?page=clsstudent&cls=<?php echo $fetchsql["id"];?>" style="padding: 10px 15px;"><?php echo $fetchsql["class_name"];?></a> </li> 
                    ...
                    <li> <a href="?page=clsstudent&cls=<?php echo $fetchsql["id"];?>" style="padding: 10px 15px;"  data-toggle="dropdown" class="dropdown-toggle"><?php echo $fetchsql["class_name"];?>
                ...
                <li class="dropdown"><a data-toggle="dropdown" class="dropdown-toggle">Teacher's Info &nbsp;<span class="caret" ></span></a>
                  ...
                  <?php
                    $sql = "SELECT * FROM `teachers_information` GROUP BY `Department`";
                    $resultsql  = $db->select_query($sql);
                      if($resultsql->num_rows > 0){ 
                        while($fetchSql = $resultsql->fetch_array()){
                        if($fetchSql["Department"] != ""){
                    
                  ?>



           <li><a href="?page=teacherinfo&dep=<?php echo $fetchSql['Department']?>" style="padding: 10px 15px;"><?php echo $fetchSql["Department"]?></a>
            ...
            <li><a href="http://fgc.gov.bd/?page=photo">Photo Gallery</a></li>     
            <li><a href="http://fgc.gov.bd/?page=video">Video Gallery</a></li> 
            
            <li><a href="?page=allnotice">Notice</a></li>     
            <li><a href="showResult.php">Result</a></li>     

   <li><a href="?page=OnlineClasses">Online Classes</a></li>   
                   ...
                   <!-- <li class="dropdown"><a data-toggle="dropdown" class="dropdown-toggle">Gallery  &nbsp;<span class="caret" ></span></a>-->
     <!--                 <ul class="dropdown-menu">-->
     <!--                    <li><a href="?page=photo" style="padding: 10px 15px;"> Photo Gallery</a>-->

     <!--                     </li> -->

     <!--                      <li><a href="?page=video" style="padding: 10px 15px;"> Video Gallery</a>-->
