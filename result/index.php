...
<script data-ad-client="ca-pub-8898769702359862" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
...
?>
  <meta property="og:url" content="http://fgc.gov.bd/?page=viewLecture&id=<?php print $_GET["id"]; ?>" />
  <meta property="og:type"         content="Article">
  <meta property="og:title"         content="<?php echo $fetchsql["title"];?>">
  <meta property="og:description"   content="অনলাইন লেকচার পেতে ক্লিক করুন ">
  <meta property="og:image"         content="http://fgc.gov.bd/fgc2.jpg"/>
							...
							<div class="col-md-10 col-lg-10 col-sm-12 col-xs-12  col-md-offset-1" id='boxshadow'>
										...
										break;
																		...
																		case "doner":
																			...
																			case "onlineClass":
																			{
																				include_once('onlineClass.php');
																			}
																			break;

																			case "subwiseLecture":
																			{
																				include_once('subwiseLecture.php');
																			}
																			break;

																				case "OnlineClasses":
																			{
																				include_once('online_class.php');
																			}
																			break;
