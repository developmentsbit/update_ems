...
$headmsgvice="SELECT * FROM `message_from_viceprinciple` ";
	$resultheadvic=$db->select_query($headmsgvice);
	if($resultheadvic)
	{
		$fetchheadvic=$resultheadvic->fetch_array();
	}
?>

													<!-- right section -->
															<div class="col-md-3 col-xs-12" style=" border: 1px  #ccc solid; ">
																		...
																		<!-- <section>
																			...
																			<div class="col-md-6 col-xs-6" style="width:100%; text-align:center;  margin-top:10px; height:25px; padding-top:2px;  background: -webkit-linear-gradient(top, #999999 , white);">
																						<a  href="?page=PS" id="details">Details</a>
																			</div>
																		...
																		<section>
																			...
																			<div class="col-md-6 col-xs-6" style=" width:100%; text-align:center; float:right; margin-top:10px; height:25px; padding-top:2px;  background: -webkit-linear-gradient(top, #999999 , white);">
																						<a  href="?page=head" id="details">&nbsp;Details</a>
																			</div>
																			...
																			<section>
																			<div class="col-md-12 col-xs-12"  id="introduced" style="margin-top: 5px;">
																					<span>Vice-Principal Message</span>
																			</div>
																			<div class="col-md-8 col-xs-8" style="margin:0px; padding:0px; padding-top:10px;">
																						<img src="other_img/<?php echo "vicePrinciple" ?>.jpg" style="height:180px; width:100%"  class="col-md-offset-3 col-sm-offset-3 col-xs-offset-3"/>
																		...
																		<!--<section>
																			...
																			<div class="col-md-12 col-xs-12"  id="introduced">
																				...
																				<div class="col-md-12 col-xs-12"  id="rightblock">
																						...
																						<ul>
																							<li><a href="?page=staff&cls=staff"><i class="fa fa-check-square-o"></i>&nbsp; &nbsp; Staff's Information</a></li>
																						</ul>
																				</div>
																				...
																				<div class="col-md-12 col-xs-12"  id="rightblock">
																						...
																						<ul>
																							<li><a href="?page=zero"><i class="fa fa-check-square-o"></i>&nbsp; &nbsp; Zero Designation Info</a></li>
																						</ul>
																				</div>
    ...
    <ul class="social-icons">
        ...
        <li><a href="http://fgc.gov.bd/about_ads_view.php" target="_blank" class="social-icon"> <i class="fa fa-google-plus plus"></i></a></li>
    </ul>
																			...
																			<div class="col-md-12 col-xs-12" style="margin:0px; padding:0px; margin-top:10px;">
																				...
																				<div class="col-md-12 col-xs-12"  id="introduced">
																					<span>Official fan page</span>
																			</div>
																			
																				<div class="col-md-12 col-xs-12" style="margin:0px; padding:0px; margin-top:10px;">
																					   
 																		
																	<iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FFeni-Govt-College-Feni-921697791359563%2F%3Fmodal%3Dadmin_todo_tour&tabs=timeline&width=280&height=350&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="280" height="350" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>			
																			</div>
