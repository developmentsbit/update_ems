...
<?php if(isset($fetch_Sql)){echo $fetch_Sql["institute_name"]; }else {echo "";}?>
                        ...
                        <?php } } } ?>
							...
							<div class="col-lg-12" style="border-top:5px #006600 solid; margin-top:10px;" >  
							<!--<h3>Merit List(1st Year Half Yearly Exam-2020)  -->
							<!--</h3> <br>-->
							
							<!--<p><a href="http://fgc.gov.bd/admin/showMeritList.php?clID=311611180001&exId=351712140006&session=2019-2020&gpna=321710120018" target="_blank">Science</a></p>-->
							<!--<p><a href="http://fgc.gov.bd/admin/showMeritList.php?clID=311611180001&exId=351712140006&session=2019-2020&gpna=321710120017" target="_blank">Humanities</a></p>-->
							<!--<p><a href="http://fgc.gov.bd/admin/showMeritList.php?clID=311611180001&exId=351712140006&session=2019-2020&gpna=321710120016" target="_blank">Business Studies</a><p>-->
							...
							<table class="table-responsive" border="0">
  							<tr>
							<td width="998" height="92"><span style="font-size:14px; color:#8C8C8C"> Developed by: <a href='http://sbit.com.bd/' target="_blank"> Skill Based IT - SBIT </a></span></td>
