...
<div class="col-md-9 col-xs-12 fontsize backgroundcol"  style="padding:0px ; margin:0px; margin-top:10px; padding-top:10px;" >
		...
		<div class="col-md-12 col-xs-12" style="margin:0px; padding:0px; margin-top:5px;">
					...
					?>
					<?php print $_GET['dep']?> Teacher's Information
		...
		$sql="SELECT COUNT(`student_id`) FROM `running_student_info` WHERE `class_id`='".$_GET["cls"]."'";
		 ...
		 $sql="SELECT COUNT(`email`) FROM `teachers_information` where `index_no` !='1' and `index_no` !='2' and `index_no` !='01' and `index_no` !='02' and `Department`='".$_GET["dep"]."' and Type='Teacher'";
...
`teachers_information`.`designation` AS class_roll,`teachers_information`.`mobile_no` AS class_name,gender FROM `teachers_information` where `index_no` !='111' and `index_no` !='222' and  `Department`='".$_GET["dep"]."' and Type='Teacher'  ORDER BY index_no ASC $limit";
